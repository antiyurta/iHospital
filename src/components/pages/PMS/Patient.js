                            ...
                            data.map((row, index) => {
                                return (
                                    <tr key={index} className='ant-table-row ant-table-row-level-0'>
                                        ...
                                        <td className='ant-table-row-cell-break-word whitespace-normal'>{row.address}</td>
                                        <td className='ant-table-row-cell-break-word'>{moment(row.createdAt).format('YYYY/MM/DD')}</td>
                            ...
                            <Row gutter={{ md: 35, lg: 15 }}>
                                ...
                                <Col span={8}>
                                    <Form.Item
                                        ...
                                        name="registerNumber"
                                        onChange={(v) => { dada(v.target.value) }}
                                        rules={[
                                            {
                                                required: true,
