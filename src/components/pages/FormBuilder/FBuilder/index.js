                                ...
                                <div className="p-2">
                                    <div className="flex flex-wrap">
                                        <div className="basis-5/12 p-1">
                                            <Form.Item {...restField} label="Хэжмээ" name={[name, "style"]}>
                                                <Select options={styleOptions}></Select>
                                            </Form.Item>
                                        </div>
                                        <div className="basis-6/12 p-1">
                                            <Form.Item {...restField} label="Нэр" name={[name, "label"]}>
                                                <Input />
                                            </Form.Item>
                                        </div>
                                        ...
                                        {(optionFields, { add, remove }) => (
                                            <>
                                                {optionFields.map((optionField) => (
                                                    <div key={optionField.key} className="rounded-md m-2" style={{ backgroundColor: '#d1d1d1' }}>
                                                        <div className="flex flex-wrap p-1">
                                                            <div className="basis-4/12 p-1">
                                                                <Form.Item {...restField} label="Төрөл" name={[optionField.name, 'type']}>
                                                                    <Select onChange={() => handleChange(namePanel, name, optionField.name)}>
                                                            ...
                                                            <div className="basis-5/12 p-1">
                                                                <Form.Item {...restField} label="Асуулт" name={[optionField.name, 'label']}>
                                                                    <TextArea />
                                                                </Form.Item>
                                                            </div>
                                                            <div className="basis-2/12 p-1">
                                                                <Form.Item {...restField} label="style" name={[optionField.name, 'style']}>
                                                                    <Select options={styleOptions}></Select>
                                                                </Form.Item>
                                                                <Form.Item {...restField} label="labelCol" name={[optionField.name, 'labelCol']}>
                                                                    <InputNumber maxLength={2} />
                                                                </Form.Item>
                                                                <Form.Item {...restField} label="wrapperCol" name={[optionField.name, 'wrapperCol']}>
                                                                    <InputNumber maxLength={2} />
                                                                </Form.Item>
                                                            </div>
                                                                                            ...
                                                                                            return (
                                                                                                <div className="grid-rows-2 p-1">
                                                                                                    ...
                                                                                                    <div className="p-1 text-center items-center">
                                                                                                        ...
                                                                                                        <DeleteOutlined style={{ color: 'red', fontSize: '18px' }} onClick={() => remove(optionFields.name)} />
                                                                                                    </div>
                                                                                                </div>
                                                                                            )
                                                                                        }}
