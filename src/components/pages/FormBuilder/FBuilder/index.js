                                       ...
                                       >
                                          <div className="flex flex-wrap p-1">
                                             <div className="basis-4/12 p-1">
                                                ...
                                                >
                                                   <Select
                                                      onChange={() => handleChange(namePanel, name, optionField.name)}
                                                   >
                                             ...
                                             <div className="basis-2/12 p-1">
                                                ...
                                                <Form.Item
                                                   {...restField}
                                                   label="labelCol"
                                                   name={[optionField.name, 'labelCol']}
                                                >
                                                ...
                                                <Form.Item
                                                   {...restField}
                                                   label="wrapperCol"
                                                   name={[optionField.name, 'wrapperCol']}
                                                >
                                                   <InputNumber maxLength={2} />
                                                </Form.Item>
                                             </div>
