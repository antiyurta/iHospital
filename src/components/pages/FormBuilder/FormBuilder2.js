                                                ...
                                                <div className="p-2">
                                                    <div className="flex flex-wrap">
                                                        <div className="basis-3/12 p-1">
                                                            <Form.Item {...restField} rules={basisRule} label="Төрөл" name={[name, 'type']}>
                                                                <Select options={inputTypes} onChange={() => painHandleChange(name)}></Select>
                                                            </Form.Item>
                                                        </div>
                                                        <div className="basis-3/12 p-1">
                                                            <Form.Item {...restField} rules={basisRule} label="Асуулт" name={[name, 'label']}>
                                                                <Input />
                                                            </Form.Item>
                                                        </div>
                                                        <div className="basis-3/12 p-1">
                                                            <Form.Item {...restField} rules={basisRule} label="Түлхүүр" name={[name, 'key']}>
                                                                <Input />
                                                            </Form.Item>
                                                        </div>
                                                        <div className="basis-2/12 p-1">
                                                            <Form.Item {...restField} rules={basisRule} label="Style" name={[name, 'style']}>
                                                        ...
                                                        {(optionFields, { add, remove }) => (
                                                            <>
                                                                {optionFields.map((optionField) => (
                                                                    <div style={{ display: result() ? "" : 'none' }} className="rounded-md bg-white m-2" key={optionField.key}>
                                                                        <div className="p-2">
                                                                            <Form.Item
                                                                                noStyle
                                                                                shouldUpdate
