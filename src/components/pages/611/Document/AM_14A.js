         ...
         <div className="subpage-landscape">
            ...
            >
               ...
               >
                  ...
                  <span style={{ fontWeight: 'bold', fontSize: 12 }}>Эрүүл мэндийн бүртгэлийн маягт АМ-14А</span>
               </div>
            </div>
            <div style={{ textAlign: 'center' }}>
               <span style={{ fontWeight: 'bold', fontSize: 16 }}>ЖИРЭМСЭН ЭМЭГТЭЙЧҮҮДИЙН БҮРТГЭЛ</span>
            </div>
            <Table bordered className="document">
               <tbody>
                  <tr>
                     <td rowSpan={4} style={{ ...textStyle.centerText, ...{ width: 40 } }}>
                        Д/д
                     </td>
                     <td
                        rowSpan={4}
