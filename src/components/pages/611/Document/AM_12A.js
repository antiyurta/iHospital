         ...
         <div className="subpage-landscape">
            <div>
               ...
               >
                  ...
                  <span style={{ fontWeight: 'bold', fontSize: 10 }}>Эрүүл мэндийн бүртгэлийн маягт АМ-12А</span>
               </div>
               <div
                  style={{
                     display: 'flex',
               ...
               <div style={{ textAlign: 'center' }}>
                  <span style={{ fontWeight: 'bold', fontSize: 14 }}>ЭМНЭЛЭГ ХЯНАЛТЫН КОМИССООР ОРОГЧДЫН БҮРТГЭЛ</span>
               </div>
            </div>{' '}
