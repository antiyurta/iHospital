            ...
            <div className="subpage">
               ...
               >
                  ...
                  <div>
                     ...
                     ></span>
                     <span style={{ fontWeight: 'bold', fontSize: 12 }}>Эрүүл мэндийн бүртгэлийн маягт АМ-22К</span>
                  </div>
               </div>
               ...
               <div style={{ textAlign: 'center', marginBottom: 5 }}>
                  <span style={{ fontWeight: 'bold', fontSize: 12 }}>Нян судлалын лабораторийн шинжилгээний дүн</span>
               </div>
               <Table bordered className="document" style={{ marginTop: 20, marginBottom: 0 }}>
                  <tbody>
                     ...
                     <tr>
                        ...
                        <td style={{ ...styles.centerText, ...{ width: 100 } }}>Наац</td>
               ...
               <Table bordered className="document" style={{ marginBottom: 0 }}>
                  <tbody>
                     <tr>
                        ...
                        <td style={styles.centerText}></td>
                        <td style={{ ...styles.centerText, ...{ width: 300 } }}>13 А маягтын дугаар</td>
                        <td style={styles.centerText}></td>
                     </tr>
                  </tbody>
               </Table>
               ...
               <Table bordered className="document" style={{ marginBottom: 0 }}>
                  <tbody>
                     <tr>
                        <td style={{ ...styles.centerText, ...{ width: 100 } }}>Төрөл</td>
                        <td style={{ ...styles.centerText, ...{ width: 100 } }}>Ялгадас</td>
                        <td style={{ ...styles.centerText, ...{ width: 30 } }}></td>
                        <td style={{ ...styles.centerText, ...{ width: 50 } }}>Бусад</td>
                        <td style={{ ...styles.centerText, ...{ width: 150 } }}></td>
                     </tr>
                  </tbody>
               </Table>
               <Table bordered className="document" style={{ marginBottom: 0 }}>
                  <tbody>
                     <tr>
                        <td style={{ ...styles.leftText, ...{ width: '50%' } }}>Сорьцын дугаар</td>
                        <td style={{ ...styles.centerText, ...{ width: '50%' } }}></td>
                     </tr>
                  </tbody>
               </Table>
               ...
               <Table bordered className="document" style={{ marginBottom: 0 }}>
                  <tbody>
                     <tr>
                        <td style={{ ...styles.leftText, ...{ width: '20%' } }}>Онош</td>
               ...
               <Table bordered className="document">
                  <tbody>
                     <tr>
                        <td rowSpan={2} style={{ ...styles.centerText, ...{ width: '25%' } }}>
                           Шинжлэгдэхүүн
                        </td>
                        <td rowSpan={2} style={{ ...styles.centerText, ...{ width: '25%' } }}>
                           Эрэгтэй шээсний сүв
                        </td>
                        <td colSpan={2} style={{ ...styles.centerText, ...{ width: '50%' } }}>
                           Эмэгтэй
                        </td>
                     </tr>
                     <tr>
                        <td style={{ ...styles.centerText, ...{ width: '25%' } }}>Үтрээнд</td>
                        <td style={{ ...styles.centerText, ...{ width: '25%' } }}>Умайн хүзүүний суваг</td>
                     </tr>
                     <tr>
         ...
         <div className="page">
            <div className="subpage">
               ...
               >
                  ...
                  <span style={{ marginLeft: 30 }}>Хариу гарсан огноо:...........................</span>
               </div>
               <div
                  style={{
                     ...styles.rowStyle,
