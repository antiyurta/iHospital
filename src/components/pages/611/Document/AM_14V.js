         ...
         <div className="subpage-landscape">
            ...
            >
               ...
               >
                  ...
                  <span style={{ fontWeight: 'bold', fontSize: 12 }}>Эрүүл мэндийн бүртгэлийн маягт АМ-14В</span>
               </div>
            </div>
            ...
            <Table bordered className="document">
               <tbody>
                  ...
                  <tr>
                     <td style={textStyle.verticalText}>Жирэмсний хяналтанд ороогүй</td>
                     <td style={textStyle.verticalText}>Хожуу үеийн зулбалт /13-21 долоо хоног/</td>
                     <td style={textStyle.verticalText}>Дутуу төрөлт /22-с дээш долоо хоног/</td>
                     <td style={textStyle.verticalText}>Амьгүй төрөлт</td>
                     <td style={textStyle.verticalText}>Давтан шинжилгээнд хамрагдаагүй-1,</td>
