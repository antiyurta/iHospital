      ...
      <>
         <div className="page">
            <div className="subpage">
               ...
               <div style={{ textAlign: 'center', marginTop: 5, marginBottom: 5 }}>
                  <span style={{ fontWeight: 'bold', fontSize: 14 }}>ӨДРИЙН ЭМЧИЛГЭЭНИЙ БҮРТГЭЛ /Насанд хүрэгчид/</span>
               </div>
               <div
                  style={{
                     ...styles.rowStyle,
               ...
               <div style={styles.rowStyle}>
                  РД. . . . . . . . . . . . . . . . . . . . . . . . . нас. . . . . . . . . . . . . эр / эм
                  <span style={{ marginLeft: 20 }}>ӨЭ Хуудас №. . . . . . . . . . . . . . . . . . . . . . . . . .</span>
               </div>
               <div style={styles.rowStyle}>
                  Мэс заслын өмнөх өрөөнд ирсэн: . . . . . . . цаг. . . . . . . . . минут.
                  <span style={{ marginLeft: 100 }}>Сувилагч. . . . . . . . . . . . .</span>
               </div>
               ...
               <Table bordered className="document" style={{ marginBottom: 0 }}>
                  <tbody>
                     ...
                     <tr>
                        ...
                        {[...Array(20)].map((x, i) => (
                           <td style={{ ...styles.centerText, ...{ width: 15 } }} key={i}></td>
                        ))}
                     </tr>
                     <tr>
               ...
               <div style={styles.rowStyle}>
                  хуудсыг хааж үйлчлүүлэгчийг аав/ ээж/ асран хамгаалагч/ . . . . . . . . . . . . . .тасагт хүлээлгэн
                  өгөв:
               </div>
               <div style={styles.rowStyle}>
               ...
               <div style={styles.rowStyle}>
                  Зүрхний цохилт. . . . . . . . . , Артерийн даралт. . . . . /. . . . . . / . . . . , Биеийн хэм. . . .
                  . . . , FiO2 . . . . . . ,
               </div>
               <div style={styles.rowStyle}>
               ...
               <div style={styles.rowStyle}>
                  Үйлчлүүлэгч............................-ны аав/ ээж/ асран хамгаалагч (.........................) би
                  хүүхдийнхээ асаргаа сувилгааны зөвлөгөөг авсан / аваагүй (зур). Зөвлөгөөг зааврын дагуу сахих болно.
               </div>
               <div style={styles.rowStyle}>
         ...
         <div className="page">
            <div className="subpage">
               ...
               <div style={styles.rightText}>огноо: . . . . . . . . ./ . . . . . . ./ . . . . . .</div>
               <Table bordered className="document" style={{ marginBottom: 0 }}>
                  <tbody>
                     <tr>
                        ...
                        <td style={{ ...styles.centerText, ...{ width: 80, height: 20 } }} rowSpan={2}>
                           Зардал
                        </td>
                     </tr>
                     <tr>
                        <td style={{ ...styles.centerText, ...{ width: 40, height: 20 } }}></td>
                        <td style={{ ...styles.centerText, ...{ width: 40, height: 20 } }}></td>
                        <td style={{ ...styles.centerText, ...{ width: 40, height: 20 } }}></td>
                        <td style={{ ...styles.centerText, ...{ width: 40, height: 20 } }}></td>
                        <td style={{ ...styles.centerText, ...{ width: 40, height: 20 } }}></td>
                     ...
                     <tr>
                        <td style={styles.centerText}>14</td>
                        <td style={styles.centerText}>Хяналтын өрөөний эмчилгээний зардал</td>
