      ...
      <>
         <div className="page">
            <div className="subpage">
               ...
               <div style={styles.rowStyle}>Мэдээлсэн огноо: ______________________________________________</div>
                  ...
                  <tbody>
                     <tr>
                        ...
                        <td style={styles.leftText}>
                           ...
                           <div style={styles.leftText}>Сум / Дүүрэг: _______________</div>
                           <div style={styles.leftText}>Баг / Хороо: _______________</div>
                           <div style={styles.leftText}>Хэсэг / Хороолол: ___________</div>
                           <div style={styles.leftText}>Газар / Гудамж / Байр:_______</div>
                     ...
                     <tr>
                        <td style={styles.topText}>
                           ...
                           <div style={styles.rowCellWithText}>
                              <div style={styles.rowCellsSm}></div>&nbsp;Хөдөлмөр эрхлэлтийн байдал
                           </div>
                           <div style={styles.rowCellWithText}>
                              <div style={styles.rowCellsSm}></div>&nbsp;Хөдөлмөр эрхлэхгүй шалтгаан
                           </div>
                        </td>
                        <td style={styles.topText}>
                        ...
                        <td style={styles.leftText}>
                           ...
                           <div style={styles.rowCellWithText}>
                              <div style={styles.rowCellsSm}></div>&nbsp;Мэргэжлийн болон техникийн
                           </div>
                           <div style={styles.rowCellWithText}>
               ...
               <Table bordered className="document" style={{ marginBottom: 0 }}>
                  <tbody>
                     <tr>
                        ...
                        <td style={styles.topText}>
                           <div style={styles.rowStyle}>16. Арьс салст шарласан эсэх:</div>
                           <div style={styles.rowCellWithText}>
                              <div style={styles.rowCellsSm}></div>&nbsp;Тийм
                           </div>
                           <div style={styles.rowCellWithText}>
                        ...
                        <td style={styles.topText}>
                           <div style={styles.rowStyle}>17.Эмнэлзүйн шинж тэмдэг эхэлсэн</div>
                           <div style={styles.rowStyle}>_______/он/</div>
                           <div style={styles.rowStyle}>_______/сар/</div>
                           <div style={styles.rowStyle}>______/өдөр/</div>
                           <div style={styles.rowStyle}>____/цаг мин/</div>
                        ...
                        <td style={styles.topText}>
                           <div style={styles.rowStyle}>20.Вирүст хепатитийн эсрэг дархлаажуулалт</div>
                           <div style={styles.rowCellWithText}>
                              <div style={styles.rowCellsSm}></div>&nbsp;Тийм
                           </div>
                           <div style={styles.rowCellWithText}>
                  ...
                  <tbody>
                     <tr>
                        ...
                        <td colSpan={4} style={styles.centerText}>
                           <div style={styles.centerText}>23.Лабораторийн шинжилгээ хийсэн: тийм-1 үгүй-2</div>
                           <div style={styles.centerText}>Аланинаминотрансфераз (АЛАТ)-ын түвшин: ОУН.......</div>
                           <div style={styles.centerText}>Аспаргиннаминотрансфераз (АСАТ)-ын түвшин: ОУН.....</div>
                        </td>
                     </tr>
                     <tr>
               ...
               <Table bordered className="document" style={{ marginBottom: 0 }}>
                  <tbody>
                     ...
                     <tr>
                        ...
                        <td style={styles.leftText}>Баталгаагүй эх үүсвэрээс ундны ус уусан</td>
                        <td style={styles.leftText}>11</td>
                     </tr>
                     <tr>
                        <td style={styles.leftText}>Мэс ажилбар хийлгэсэн</td>
                        <td style={styles.leftText}>2</td>
                        <td style={styles.leftText}>Баталгаагүй хүнсний бүтээгдэхүүн хэрэглэсэн</td>
                        <td style={styles.leftText}>12</td>
                     </tr>
                     <tr>
                        <td style={styles.leftText}>Цус цусан бүтээгдэхүүн сэлбүүлсэн</td>
                        <td style={styles.leftText}>3</td>
                        <td style={styles.leftText}>Өвчлөл гарсан хүүхдийн байгууллагын хүүхэд эсвэл ажилтан</td>
                        <td style={styles.leftText}>13</td>
                     </tr>
                     <tr>
                        <td style={styles.leftText}>Шүд эмчлүүлсэн</td>
                        <td style={styles.leftText}>4</td>
                        <td style={styles.leftText}>Вирүст хепатитийн өвчлөл өндөртэй газар очсон</td>
                        <td style={styles.leftText}>14</td>
                     </tr>
                     <tr>
                        <td style={styles.leftText}>Үр хөндөлт хийлгэсэн</td>
                        <td style={styles.leftText}>5</td>
                        <td style={styles.leftText}>Гэр бүлд вирүсийн халдвартай хүн байгаа</td>
                     ...
                     <tr>
                        ...
                        <td style={styles.leftText}>
                           Шүдний сойз, сахлын хутга, хумсны хутга гэх мэт хувийн ариун цэврийн хэрэглэлийг дамжуулан
                           хэрэглэдэг
                        </td>
                        <td style={styles.leftText}>16</td>
                     </tr>
                     <tr>
                        <td style={styles.leftText}>Арьс цоолох, гоо сайхны эмчилгээ үйлчилгээ хийлгэсэн</td>
                        <td style={styles.leftText}>7</td>
                        <td style={styles.leftText}>Эрчүүдтэй бэлгийн хавьталд ордог эрчүүд</td>
                     ...
                     <tr>
                        ...
                        <td style={styles.leftText}>
                           Эмнэлгийн ажилтан тусламж үйлчилгээ хийж байх үедээ өвчтөний цусанд хүрсэн
                        </td>
                        <td style={styles.leftText}>9</td>
                        <td style={styles.leftText}>Мансууруулах бодис хэрэглэдэг, бэлгийн харьцаанд орсон</td>
                     ...
                     <tr>
                        <td colSpan={6} style={styles.centerText}>
                           <div style={styles.rowCellWithText}>
                              ...
                              <div style={{ ...styles.rowCellsSm, ...{ marginLeft: 50 } }}></div>
                              &nbsp;Эмнэлзүйгээр
                              <div style={{ ...styles.rowCellsSm, ...{ marginLeft: 50 } }}></div>
