...
function AM35() {
   ...
   return (
      <>
            ...
            <div className="subpage">
               ...
               >
                  ...
                  >
                     ...
                     <span style={{ fontWeight: 'bold', fontSize: 14 }}>Эрүүл мэндийн бүртгэлийн маягт АМ-35</span>
                  </div>
               </div>

               <div style={{ textAlign: 'center', marginTop: 15, marginBottom: 15 }}>
                  <span style={{ fontWeight: 'bold', fontSize: 16 }}>ХӨДӨЛМӨР ЗАСЛЫН ҮНЭЛГЭЭНИЙ ХУУДАС</span>
               </div>
               ...
               <div style={styles.leftBold}>Modified Barthel Index (өдөр тутмын үйл ажиллагааны чадвар)</div>
               <Table bordered className="document" style={{ marginTop: 10, marginBottom: 0 }}>
                  <tbody>
                     <tr>
         ...
         <div className="page">
            <div className="subpage">
               <div style={styles.rowStyle}>1. Бэрхшээлтэй асуудлыг тодорхойлж жагсаах:</div>
               ...
               <div style={styles.rowStyle}>3. Урт хугацааны дараа хүрэх үр дүнгийн зорилго, хугацаа:</div>
               <div style={styles.leftText}>
                  ____________________________________________________________________________________________________________________________________________
               </div>
               <div style={styles.leftText}>
               ...
               <div style={styles.rowStyle}>4. Хөдөлмөр засал эмчилгээний төлөвлөгөө:</div>
               <div style={styles.leftText}>
                  ____________________________________________________________________________________________________________________________________________
               </div>
               <div style={styles.leftText}>
               ...
               <div style={styles.centerBold}>Хөдөлмөр засалч /Ахуй засалч/: ___________________________</div>
