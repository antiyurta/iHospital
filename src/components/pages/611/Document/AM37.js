         ...
         <div className="subpage">
            <div>
               ...
               >
                  ...
                  <span style={{ fontWeight: 'bold', fontSize: 12 }}>Эрүүл мэндийн бүртгэлийн маягт АМ-37</span>
               </div>
               <div style={{ textAlign: 'center', marginBottom: 5 }}>
                  <span style={{ fontWeight: 'bold', fontSize: 14 }}>НҮҮР АМНЫ ЭМЧЛЭГЧ ЭМЧИЙН ЭМЧИЛГЭЭНИЙ БҮРТГЭЛ</span>
               </div>
            </div>
