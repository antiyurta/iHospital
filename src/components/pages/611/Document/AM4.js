         ...
         <div className="page">
            <div className="subpage">
               ...
               >
                  ...
                  <span style={{ marginLeft: 40 }}>Мэдээлсэн огноо: ____/____/___</span>
               </div>
                  ...
                  <tbody>
                     <tr>
                        <td style={styles.leftText} colSpan={2}>
                           ...
                           <div style={styles.rowCellWithText}>
                              <div style={styles.rowCells}></div>&nbsp;Эмчилгээ үр дүнгүй болсны дараах
                           </div>
                           <div style={styles.rowCellWithText}>
                              <div style={styles.rowCells}></div>&nbsp;Хяналт алдагдсаны дараах
                           </div>
                           <div style={styles.rowCellWithText}>
                              <div style={styles.rowCells}></div>&nbsp;Эмчилгээний үр дүн тодорхойгүй
                           </div>
                           <div style={styles.rowCellWithText}>
                              <div style={styles.rowCells}></div>&nbsp;Өмнөх эмчилгээний түүх тодорхойгүй
                           </div>
                        </td>
                        <td style={styles.leftText} colSpan={12}>
                           <b>Тохиолдлын илрүүлсэн арга:</b>
                           <div style={styles.rowCellWithText}>
                              <div style={styles.rowCells}></div>&nbsp;Өвчний учир амбулаториор /идэвхигүй/
                           </div>
                           <div style={styles.rowCellWithText}>
                              <div style={styles.rowCells}></div>&nbsp;Идэвхитэй илрүүлэлтээр
                           </div>
                           <div style={styles.rowCellWithText}>
                              <div style={styles.rowCells}></div>&nbsp;Хавьтлын илрүүлэлтээр
                           </div>
                           <div style={styles.rowCellWithText}>
                              <div style={styles.rowCells}></div>&nbsp;Урьдчилан сэргийлэх үзлэгээр
                           </div>
                           <div style={styles.rowCellWithText}>
                              <div style={styles.rowCells}></div>&nbsp;Бусад /задлан шинжилгээ-нас барсан
                           </div>
                     ...
                     <tr>
                        ...
                        <td style={styles.leftText} colSpan={12}>
                           <b>Огноо:</b>
                           <div style={styles.rowStyle}>Өвчин эхэлсэн: ____/____/____</div>
                           <div style={styles.rowStyle}>Эмчид үзүүлсэн: ___/___/___</div>
                           <div style={styles.rowStyle}>Оношлогдсон: ____/____/____</div>
                           <div style={styles.rowStyle}>Бүртгэлд авсан: ____/____/____</div>
                           <div style={styles.rowStyle}>Эмчилгээ эхэлсэн: ___/____/______</div>
                        </td>
                     </tr>
                     <tr>
                        <td style={styles.leftText} colSpan={2}>
                  ...
                  <tbody>
                     <tr>
                        ...
                        <td style={styles.topText}>
                           ...
                           <div style={styles.rowCellWithText}>
                              <div style={styles.rowCells}></div>&nbsp;Илэрсэн ______ хоног
                           </div>
                           <div style={styles.rowCellWithText}>
                  ...
                  <tbody>
                     ...
                     <tr>
                        <td style={styles.topText}>
                           ...
                           <div style={styles.rowCellWithText}>
                              <div style={styles.rowCells}></div>&nbsp;Хэвийн бус-хөндийгүй
                           </div>
                           <div style={styles.rowCellWithText}>
                              <div style={styles.rowCells}></div>&nbsp;Хэвийн бус-хөндийтэй
                           </div>
                           <div style={styles.rowCellWithText}>
                        ...
                        <td style={styles.topText}>
                           ...
                           <div style={{ display: 'flex', flexDirection: 'row' }}>
                              <div>
                                 <div style={styles.rowCellWithText}>
                                    <div style={styles.rowCells}></div>&nbsp;Сүрьеэгийн хавьтал
                                 </div>
                                 <div style={styles.rowCellWithText}>
                                    <div style={styles.rowCells}></div>&nbsp;Өмнө нь эмчлэгдсэн
                                 </div>
                                 <div style={styles.rowCellWithText}>
                                 ...
                                 <div style={styles.rowCellWithText}>
                                    <div style={styles.rowCells}></div>&nbsp;Эрүүл мэндийн ажилтан
                                 </div>
                                 <div style={styles.rowCellWithText}>
                              ...
                              <div style={{ marginLeft: 15 }}>
                                 ...
                                 <div style={styles.rowCellWithText}>
                                    <div style={styles.rowCells}></div>&nbsp;Дархлал дарангуйлах эмчилгээ
                                 </div>
                                 <div style={styles.rowCellWithText}>
                                    <div style={styles.rowCells}></div>&nbsp; Өдөр бүр тамхи татах
                                 </div>
                                 <div style={styles.rowCellWithText}>
                                    <div style={styles.rowCells}></div>&nbsp;Архи хэтрүүлэн хэрэглэх
                                 </div>
                                 <div style={styles.rowCellWithText}>
               ...
               <Table bordered className="document" style={{ marginBottom: 0 }}>
                  <tbody>
                     <tr>
                        ...
                        <td style={{ ...styles.leftText, ...{ width: 100 } }}>Тийм бол, ЭМЧТШ дугаар:</td>
