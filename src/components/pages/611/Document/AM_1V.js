      ...
      <div className="page-landscape">
         <div className="subpage-landscape">
            <div>
               ...
               >
                  <span style={{ fontSize: 10 }}>Эрүүл мэндийн сайдын 2019 оны 12 дугаар сарын 30-ны өдрийн</span>
                  <span style={{ fontSize: 10 }}>A/611 дүгээр тушаалын арваннэгдүгээр хавсралт</span>
                  <span style={{ fontWeight: 'bold', fontSize: 10 }}>Эрүүл мэндийн бүртгэлийн маягт АМ-1В</span>
               </div>
               <div style={{ textAlign: 'center' }}>
                  <span style={{ fontWeight: 'bold', fontSize: 14 }}>БЗДХ-ЫН КАБИНЕТЫН ЭМЧИЙН ҮЗЛЭГИЙН БҮРТГЭЛ</span>
               </div>
               <div
                  style={{
                     display: 'flex',
               ...
               >
                  ...
                  <div style={styles.leftText}>Кабинетийн нэр: ........................................</div>
               </div>
            </div>{' '}
            <Table bordered className="document" style={{ marginBottom: 0 }}>
               <tbody>
                  <tr>
                     ...
                     <td rowSpan={3} style={{ ...styles.centerText, ...{ width: 200 } }}>
                        Тогтмол хаяг
                     </td>
                  ...
                  <tr>
                     <td style={{ ...styles.verticalText, ...{ width: 40 } }}>Хөдөлмөр эрхлэлт /код 01-07/</td>
                  ...
                  <tr>
                     {[...Array(21)].map((x, i) => (
                        <td style={styles.centerText} key={i} colSpan={i == 2 ? 10 : null}>
                           {i + 1}
                        </td>
                     ))}
                  </tr>
                  <tr>
                     <td rowSpan={2} style={{ ...styles.centerText, ...{ height: 15 } }}>
                        &nbsp;
                     </td>
                     <td rowSpan={2} style={{ ...styles.centerText, ...{ height: 15 } }}>
                        &nbsp;
                     </td>
                     <td colSpan={10} style={{ ...styles.centerText, ...{ height: 15 } }}></td>
                     {[...Array(18)].map((x, i) => (
                        <td rowSpan={2} key={i} style={{ ...styles.centerText, ...{ height: 15 } }}>
                           &nbsp;
                        </td>
                     ))}
                  </tr>
                  <tr>
                     {[...Array(12)].map((x, i) => (
                        <td style={{ ...styles.centerText, ...{ width: 15, height: 15 } }}>&nbsp;</td>
                     ))}
                  </tr>
                  {[...Array(12)].map((x, i) => (
                     <>
