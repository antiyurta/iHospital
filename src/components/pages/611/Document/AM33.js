      ...
      <>
         <div className="page">
            <div className="subpage">
               ...
               >
                  А 2. Эцэг /эх/-ийн нэр ______________________ А3. Нэр _______________________ А4. РД
                  ...
                  <tbody>
                     ...
                     <tr>
                        ...
                        <td rowSpan={2} colSpan={2} style={styles.centerText}>
                           <div>Бусад / бичих / ______________________________________</div>
               ...
               <Table bordered className="document">
                  <tbody>
                     ...
                     <tr>
                        ...
                        <td style={{ ...styles.centerText, ...{ width: 20 } }}>2</td>
                        <td style={styles.leftText}>Бусад хүн, амьтанд хазуулах, хатгуулах, өшиглүүлэх /бичих/</td>
                     ...
                     <tr>
                        <td style={{ ...styles.leftText, ...{ width: 200 } }}>Бусад уналт /бичих/___________</td>
                     ...
                     <tr>
                        ...
                        <td style={{ ...styles.leftText, ...{ width: 200 } }}>Хурц зүйл /бичих/___________</td>
                     ...
                     <tr>
                        <td style={{ ...styles.leftText, ...{ width: 200 } }}>Мохоо зүйлд /бичих/_________</td>
                     ...
                     <tr>
                        <td rowSpan={2} style={{ ...styles.leftText, ...{ width: 200 } }}>
                           Бусад /бүх төрлийн буу, даралтат хийтэй зүйл, сальют гэх мэт бичих/ ________________
                        </td>
                        <td rowSpan={2} style={{ ...styles.centerText, ...{ width: 20 } }}>
                           16
                        </td>
                        <td rowSpan={2} style={{ ...styles.leftText, ...{ width: 20 } }}></td>
                        <td style={styles.leftText}>Бусад осол /бичих/_______________________________</td>
                        <td style={styles.centerText}>98</td>
                     </tr>
                     <tr>
                        <td style={styles.leftText}>Тодорхойгүй осол ________________________________</td>
                        <td style={styles.centerText}>99</td>
                     </tr>
                  </tbody>
               </Table>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column' }}>
                           <Table bordered className="document">
                              <tbody>
                                 ...
                                 <tr>
                                    <td style={styles.leftText}>Спирт, бусад бодис /бичих/_____</td>
                                    <td style={styles.centerText}>2</td>
                                 </tr>
                                 <tr>
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', width: '48%' }}>
                     <Table bordered className="document">
                        <tbody>
                           ...
                           <tr>
                              <td style={{ ...styles.centerText, ...{ height: 115 } }}></td>
                           </tr>
                        </tbody>
                     </Table>
                  </div>
