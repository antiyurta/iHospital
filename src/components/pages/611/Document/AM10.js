      ...
      <>
         <div className="page">
            <div className="subpage">
               ...
               <div style={styles.leftText}>Эмнэлгийн нэр ________________________________________</div>
               <div style={styles.leftText}>
                  Олгосон ________ он _____ сар _____ өдөр{' '}
                  <span style={{ marginLeft: 30 }}>Дугаар _____________________</span>
               </div>
               <div style={styles.leftText}>
                  Эцэг /эх/-ийн нэр __________________ Нэр ____________________ Нас ___ Хүйс: (зур) эр, эм
               </div>
               <div style={styles.leftText}>Зориулалт: (зур) ажилд орох, суралцах, гэр бүл болох</div>
               ...
               <div style={styles.leftText}>Дүгнэлт, шийдвэр гаргасан ___________он_______сар_______ өдөр</div>
