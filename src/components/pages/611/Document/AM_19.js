         ...
         <div className="subpage-landscape">
            ...
            >
               ...
               >
                  ...
                  <span style={{ fontWeight: 'bold', fontSize: 12 }}>Эрүүл мэндийн бүртгэлийн маягт АМ-19</span>
               </div>
            </div>
            <div style={{ textAlign: 'center', marginBottom: 10 }}>
               <span style={{ fontWeight: 'bold', fontSize: 16 }}>ҮР ХӨНДӨЛТИЙН БҮРТГЭЛ</span>
            </div>
            <Table bordered className="document">
               <tbody>
                  <tr>
                     <td rowSpan={2} style={{ ...textStyle.verticalText, ...{ width: 50 } }}>
                        Он, сар, өдөр
                     </td>
                     <td
                        rowSpan={2}
                     ...
                     <td rowSpan={2} style={{ ...textStyle.verticalText, ...{ width: 150 } }}>
                        Эмчийн нэр
                     </td>
                  </tr>
                  <tr>
            ...
            <div style={textStyle.generalText}>
               <b>Тайлбар: ЖСЭХ:</b> 1. Жирэмслэхээс сэргийлэх эм, 2. Тариа, 3. Суулгац, 4. Бэлгэвч, 5. Ерөндөг, 6.
               Бусад
            </div>
         </div>
      </div>
