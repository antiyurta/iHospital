                  ...
                  <tbody>
                     <tr>
                        ...
                        <td style={styles.topText}>
                           ...
                           <div style={styles.rowCellWithText}>
                              <div style={styles.rowCells}></div>&nbsp;Мэргэжлийн болон техникийн
                           </div>
                           <div style={styles.rowCellWithText}>
                     ...
                     <tr>
                        <td style={styles.topText}>
                           ...
                           <div style={styles.centerText}>он _______ сар _____ өдөр _____</div>
                        </td>
                        <td style={styles.topText} colSpan={2}>
                  ...
                  <tbody>
                     ...
                     <tr>
                        <td style={styles.leftText} colSpan={2}>
                           <b>Хорт хавдар Toronto Tier үе шатны ангиллаар: Тoronto Tier – 1, Toronto Tier - 2</b>
                        </td>
                     </tr>
                     <tr>
                        <td style={styles.leftText}>
                  ...
                  <tbody>
                           ...
                           <div style={{ display: 'flex', flexDirection: 'row' }}>
                              ...
                              <span style={{ marginLeft: 20, display: 'flex' }}>
                                 <span style={styles.rowCellWithText}>
                                    <span style={styles.rowCells}></span>&nbsp;Байран өмөн – 2
                                 </span>
                                 <span
                                    style={{
                                 ...
                                 >
                                    <span style={styles.rowCells}></span>&nbsp;Үсэрхийлсэн - 6
                                 </span>
                              </span>
                           </div>
                        </td>
                     ...
                     <tr>
                        <td style={styles.topText}>
                           ...
                           <div style={styles.rowCellWithText}>
                              <div style={styles.rowCells}></div>&nbsp;Ялгарлын зэрэг тодорхойгүй-9
                           </div>
                        </td>
                        <td style={styles.topText}>
                           ...
                           <div style={{ display: 'flex' }}>
                              ...
                              <div style={styles.rowCellWithText}>
                                 <div style={styles.rowCells}></div>&nbsp;В-эсийн /pre-B,B-precursor/ -6
                              </div>
                           </div>
                           <div style={{ display: 'flex' }}>
                              <div style={styles.rowCellWithText}>
                                 <div style={styles.rowCells}></div>&nbsp;Null эсийн / non-Т, non-B/ -7
                              </div>
                              <div style={styles.rowCellWithText}>
                                 <div style={styles.rowCells}></div>&nbsp;Киллер эсийн /natural/-8,
                              </div>
                              <div style={styles.rowCellWithText}>
                                 <div style={styles.rowCells}></div>&nbsp;эсийн төрөл тодорхойгүй-9
                              </div>
                           </div>
                        </td>
                     </tr>
                     <tr>
                        <td colSpan={2} style={styles.leftText}>
                           ...
                           <div style={styles.rowCellWithText}>
                              <div style={styles.rowCells}></div>&nbsp;Хурц лимфобласт лейкеми
                           </div>
                           <div style={styles.rowCellWithText}>
                              <div style={styles.rowCells}></div>&nbsp;Хурц миелоид лейкеми
                           </div>
                           <div style={styles.rowCellWithText}>
                           ...
                           <div style={styles.rowCellWithText}>
                              <div style={styles.rowCells}></div>&nbsp;Рабдо бус миосарком, зөөлөн эдийн сарком
                           </div>
                           <div style={styles.rowCellWithText}>
                           ...
                           <div style={styles.rowCellWithText}>
                              <div style={styles.rowCells}></div>&nbsp;Медуллобластом, бусад хөврөлийн, төв мэдрэлийн
                              системийн хавдар
                           </div>
                           <div style={styles.rowCellWithText}>
                     ...
                     <tr>
                        <td style={styles.topText}>
                           ...
                           <div style={styles.rowCellWithText}>
                              <div style={styles.rowCells}></div>&nbsp;Анхдагч ганц байрлалын хавдар-1
                           </div>
                           <div style={styles.rowCellWithText}>
                              <div style={styles.rowCells}></div>&nbsp;Анхдагч олон байрлалын хавдрын нэг тохиолдол- 2
                           </div>
                           <div style={styles.rowCellWithText}>
                        ...
                        <td style={styles.topText}>
                           ...
                           <div style={styles.rowCellWithText}>
                              <div style={styles.rowCells}></div>&nbsp;1 талыг хамарсан боловч ялгаж тусгаагүй-3
                           </div>
                           <div style={styles.rowCellWithText}>
                              <div style={styles.rowCells}></div>&nbsp;Хоёр талын хамарсан-4
                           </div>
                           <div style={styles.rowCellWithText}>
                     ...
                     <tr>
                        <td style={styles.topText}>
                           <div style={styles.rowCellWithText}>
                              <div style={styles.rowCells}></div>&nbsp;1- Нас баралтын гэрчилгээгээр
                           </div>
                           <div style={styles.rowCellWithText}>
                              <div style={styles.rowCells}></div>&nbsp;2- Эмнэл зүйн бүрдэл шинжээр
                           </div>
                           <div style={styles.rowCellWithText}>
                              <div style={styles.rowCells}></div>&nbsp;
                              <span style={{ marginLeft: 10 }}>
                                 3- Дүрс оношилгоо /КТГ, дуран, рентген, ЭХО, MRI, оношлогооны лапротоми аль нь болохыг
                                 доогуур нь зурж өөрчлөлт, хэмжээг тавих………………………………
                              </span>
                           </div>
                           <div style={styles.rowCellWithText}>
                              <div style={styles.rowCells}></div>&nbsp;4-Лабораторийн оношлуур /цус, хавдрын өвөрмөц
                              маркер, иммунологи аль нь болохыг доогуур нь зурж өөрчлөлт, хэмжээг тавих………………………………
                           </div>
                        </td>
                        <td style={styles.topText}>
                           <div style={styles.rowCellWithText}>
                           ...
                           <div style={styles.rowCellWithText}>
                              <div style={styles.rowCells}></div>&nbsp;6-Эдийн шинжилгээ үсэрхийлсэн эдээс /задлан
                              шинжилгээний эд хамаарна/
                           </div>
                           <div style={styles.rowCellWithText}>
                              <div style={styles.rowCells}></div>&nbsp;7 - Эдийн шинжилгээ анхдагч эдээс /задлан
                              шинжилгээний эд, ясны эд хамаарна/
                           </div>
                           <div style={styles.rowCellWithText}>
                              <div style={styles.rowCells}></div>&nbsp;8- Мэдэхгүй
                           </div>
                           <div style={styles.topText}>
                              Эд, эсийн шинжилгээ хийсэн эмнэлгийн нэр:___________________________________
                           </div>
                           <div style={styles.topText}>
                              Эд, эсийн шинжилгээний баримтын дугаар: _______________________________________
                           </div>
                        </td>
                     </tr>
                  </tbody>
                  ...
                  <tbody>
                     ...
                     <tr>
                        <td colSpan={5} style={styles.topText}>
                           ...
                           <span style={{ marginLeft: 200 }}>Мэс засал хийсэн эмнэлгийн нэр:</span>
                           <div style={styles.leftText}>
                              Хагалгаа хийсэн эмчийн нэр:
                              <span style={{ marginLeft: 300 }}>эмчийн утасны дугаар:__________</span>
                           </div>
                        </td>
                     </tr>
                     <tr>
                     ...
                     <tr>
                        ...
                        <td colSpan={4} style={styles.topText}>
                           Мэдээлсэн албан тушаалтан: <span style={{ marginLeft: 150 }}>/</span>
