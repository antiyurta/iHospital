import { Badge, Button, Card, Form, Input, message, Modal, Select, Switch, Upload } from "antd";
...
import { EditOutlined, EllipsisOutlined, LoadingOutlined, PlusOutlined, SettingOutlined } from '@ant-design/icons';
...
function EquipmentList() {
    ...
    const getEquipments = async () => {
        ...
        await Promise.all(data.map(async (equip) => {
