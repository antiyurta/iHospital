    ...
    return (
        <>
            ...
            <div ref={printRef} className="magadlagaa">
                ...
                <p className="text-center font-bold" style={{ fontSize: "18px" }}>ЭМНЭЛГИЙН МАГАДЛАГАА</p>
                ...
                <div className="inline-flex">
                    ...
                    <p style={{ fontSize: "14px" }} className={patientInfo?.genderType === 'MAN' ? "underline pr-1" : "pr-1"}>эрэгтэй</p>
                    <p style={{ fontSize: "14px" }}>,</p>
                    <p style={{ fontSize: "14px" }} className={patientInfo?.genderType === 'WOMEN' ? "underline pr-1" : "pr-1"}>эмэгтэй</p>
                </div>
                <div className="inline-flex">
                ...
                <div>
                    <p style={{ fontSize: "14px" }}>5. Тогтмол хаяг______________________________________________________________</p>
                    <p style={{ fontSize: "14px" }}>_______________________________________________________________________________</p>
                </div>
                <div>
                    <p style={{ fontSize: "14px" }}>6. Ажлын газар, албан тушаал______________________________________________</p>
                    <p style={{ fontSize: "14px" }}>_______________________________________________________________________________</p>
                </div>
                <div>
                    <p style={{ fontSize: "14px" }}>7. Мэргэжил_________________________________________________________________</p>
                    <p style={{ fontSize: "14px" }}>_______________________________________________________________________________</p>
                </div>
                <div className="inline-flex">
                    <p style={{ fontSize: "14px" }}>8.</p>
                    <p style={{ fontSize: "14px" }}>(зур)</p>
                    <a style={{ fontSize: "14px" }} className={ob ? "underline pr-1" : "pr-1"} onClick={() => ddd(0)}>өвчтэй байсан</a>
                    <p style={{ fontSize: "14px" }}>,</p>
                    <a style={{ fontSize: "14px" }} className={oa ? "underline pr-1" : "pr-1"} onClick={() => ddd(1)}>өвчтөн асрамжилсан</a>
                    <p style={{ fontSize: "14px" }}>,</p>
                    <a style={{ fontSize: "14px" }} className={hh ? "underline pr-1" : "pr-1"} onClick={() => ddd(2)}>хөл хоригдсон</a>
                    <p style={{ fontSize: "14px" }}>,</p>
                    <a style={{ fontSize: "14px" }} className={eu ? "underline pr-1" : "pr-1"} onClick={() => ddd(3)}>эмчид үзүүлсэн</a>
                    <p style={{ fontSize: "14px" }}>,</p>
                    <a style={{ fontSize: "14px" }} className={sh ? "underline pr-1" : "pr-1"} onClick={() => ddd(4)}>шилжилгээ</a>
                    <p style={{ fontSize: "14px" }}>,</p>
                    <a style={{ fontSize: "14px" }} className={ae ? "underline pr-1" : "pr-1"} onClick={() => ddd(5)}>ариутгал эмчилгээ</a>
                    <p style={{ fontSize: "14px" }}>,</p>
                </div>
                <div className="inline-flex align-middle">
                    <a style={{ fontSize: "14px" }} className={pz ? "underline pr-1" : "pr-1"} onClick={() => ddd(6)}>протез</a>
                ...
                <div className="inline-flex">
                    ...
                    <a style={{ fontSize: "14px" }} className={work ? "underline pr-1" : "pr-1"} onClick={() => dddd(0)}>ажлаас</a>
                    <p style={{ fontSize: "14px" }}>,</p>
                    <a style={{ fontSize: "14px" }} className={school ? "underline pr-1" : "pr-1"} onClick={() => dddd(1)}>хичээлээс</a>
                    <p style={{ fontSize: "14px" }}>{`)`}</p>
                    <p style={{ fontSize: "14px" }}>чөлөөлснийг магадлав.</p>
                </div>
                <br />
                <div>
                    <p style={{ fontSize: "14px" }}>9. Асрамжинд байсан хүний эцэг /эх/-ийн нэр, хэн болох____________________________</p>
                    <p style={{ fontSize: "14px" }}>_______________________________________________________________________________</p>
                </div>
                <div className="inline-flex">
                ...
                <p className="font-bold" style={{ fontSize: "16px" }}>СУНГАЛТ</p>
                <div>
                    <p style={{ fontSize: "14px" }}>1. _______ оны _______ сарын _______ өдрөөс _______ оны _______ сарын _______ өдөр хүртэл нийт</p>
                ...
                <div>
                    <p style={{ fontSize: "14px" }}>2. _______ оны _______ сарын _______ өдрөөс _______ оны _______ сарын _______ өдөр хүртэл нийт</p>
                    <p style={{ fontSize: "14px" }}>_____________________хоногоор сунгав</p>
                </div>
                <div className="flex flex-wrap">
                    <div className="basis-1/2 text-center">
                ...
                <div>
                    <p style={{ fontSize: "14px" }}>3. _______ оны _______ сарын _______ өдрөөс _______ оны _______ сарын _______ өдөр хүртэл нийт</p>
                    <p style={{ fontSize: "14px" }}>_____________________хоногоор сунгав</p>
                </div>
                <div className="flex flex-wrap">
                    <div className="basis-1/2 text-center">
