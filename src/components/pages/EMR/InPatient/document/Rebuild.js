                ...
                <Form form={form}>
                    ...
                    <Table bordered>
                        <tbody>
                            ...
                            <tr>
                                <th colSpan={2} className="text-center">Бие ерөнхий байдал</th>
                                <th colSpan={1} className="text-center">Ухаан санаа</th>
                                <th colSpan={2} className="text-center">Арьс салст</th>
                            </tr>
                            <tr>
                                <td colSpan={2}>
                                    <Form.Item
