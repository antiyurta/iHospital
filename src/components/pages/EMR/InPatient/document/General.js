               ...
               <tr>
                  ...
                  <td style={{ width: 280 }}>
                     <span>
                        ...
                        <Form.Item shouldUpdate className="mb-0" noStyle name={['general', 'unNormalskincolor']}>
               ...
               <tr style={{ borderTopWidth: 0 }}>
                  <td className="w-64">
                     <span>
                        ...
                        <Form.Item shouldUpdate className="mb-0" noStyle name={['general', 'breathOneMinute']}>
                  ...
                  <td>
                     <div className="flex flex-wrap">
                        <div className="basis-1/2">
                           ...
                           <Form.Item shouldUpdate className="mb-0" noStyle name={['general', 'hear']}>
                              <Checkbox.Group className="ml-0">
                                 <Checkbox className="ml-2" value={0}>
                                    Уушги цулцангийн
                                 </Checkbox>
                        ...
                        <div className="basis-1/2">
                           ...
                           <span>
                              (
                              <Form.Item shouldUpdate className="mb-0" noStyle name={['general', 'unNormalBreath']}>
         ...
         <Table bordered className="story mb-0">
            <thead>
               ...
               <tr>
                  <td className="w-36">
                     ...
                     <p>
                        минутанд
                        <span>
                           <Form.Item shouldUpdate className="mb-0" noStyle name={['general', 'veinsOneMinute']}>
                              <Input className="amaraInput w-10" style={{ textAlign: 'center' }} />
                           </Form.Item>
                        </span>
                        удаа
                     ...
                     <p>
                        дүүрэлт
                        <span>
                           <Form.Item shouldUpdate className="mb-0" noStyle name={['general', 'voltage']}>
                  ...
                  <td className="w-36">
                     ...
                     <p>Зүрхний хил</p>
                     <Form.Item shouldUpdate className="mb-0" noStyle name={['general', 'touchHeart']}>
                        <Checkbox.Group className="ml-0">
                     ...
                     <span>
                        (
                        <Form.Item shouldUpdate className="mb-0" noStyle name={['general', 'touchHeartUnNormal']}>
                           <Checkbox.Group className="inline">
                              <Checkbox className="test" value={0}>
                                 баруун
                              </Checkbox>
                  ...
                  <td style={{ width: 280 }}>
                     <p className="font-bold">Чагналтаар:</p>
                     <p>Зүрхний хил</p>
                     <Form.Item shouldUpdate className="mb-0" noStyle name={['general', 'hearHeart']}>
                        <Checkbox.Group className="ml-0">
                           <Checkbox className="ml-2" value={0}>
                              Тод
                           </Checkbox>
                     ...
                     <p>
                        АД баруун талд
                        <Form.Item shouldUpdate className="mb-0" noStyle name={['general', 'adRight']}>
                           <Input className="w-10" style={{ textAlign: 'center' }} />
                        </Form.Item>
                        Зүүн талд
                        <Form.Item shouldUpdate className="mb-0" noStyle name={['general', 'adLeft']}>
                           <Input className="w-10" style={{ textAlign: 'center' }} />
                        </Form.Item>
                        талдаа
                     </p>
               ...
               <tr>
                  <td>
                     <p>Хэл</p>
                     <Form.Item shouldUpdate className="mb-0" noStyle name={['general', 'tongue']}>
                        <Checkbox.Group className="ml-0">
                           <Checkbox className="ml-2" value={0}>
                              Ердийн
                           </Checkbox>
                  ...
                  <td colSpan={2}>
                     <p>Хэвлийн үзлэг:</p>
                     <Form.Item shouldUpdate className="mb-0" noStyle name={['general', 'abdominal']}>
                        <Checkbox.Group className="ml-0">
                           <Checkbox className="ml-2" value={0}>
                              Өнгөц тэмтрэлтээр
                           </Checkbox>
                     ...
                     <p className="ml-24">
                        (байрлал:&nbsp;
                        <Form.Item shouldUpdate className="mb-0" noStyle name={['general', 'injury2']}>
                     ...
                     <Form.Item shouldUpdate className="mb-0" noStyle name={['general', 'abdominal']}>
                        <Checkbox.Group className="ml-0">
                           ...
                           <Checkbox value={4}>Зөөлөн гялтан цочрол үгүй</Checkbox>
                           <Checkbox value={5}>Гялтан цочролыэн шинж илэрсэн</Checkbox>
                        </Checkbox.Group>
                     </Form.Item>
                  </td>
               </tr>
         ...
         <Table bordered className="story mb-0">
            <thead>
               ...
               <tr>
                  <td>
                     <p>Сонсох чадвахи:</p>
                     <Form.Item shouldUpdate className="mb-0" noStyle name={['general', 'hearStatus']}>
                        <Checkbox.Group className="ml-0">
                           <Checkbox className="ml-2" value={0}>
                              Хэвийн
                           </Checkbox>
                     ...
                     (
                     <Form.Item shouldUpdate className="mb-0" noStyle name={['general', 'hearStatusIsLow']}>
                        <Checkbox.Group className="inline">
                           <Checkbox className="test" value={0}>
                              баруун
                           </Checkbox>
                  ...
                  <td>
                     <p>Рефлексүүд:</p>
                     <Form.Item shouldUpdate className="mb-0" noStyle name={['general', 'reflex']}>
                        <Checkbox.Group className="ml-0">
                           <Checkbox className="ml-2" value={0}>
                              Хадгалагдана
                           </Checkbox>
               ...
               <tr>
                  <td colSpan={2}>
                     <p>
                        Бусад &nbsp;:
                        <Form.Item shouldUpdate className="mb-0" noStyle name={['general', 'others']}>
                     ...
                     <p>
                        <span>
                           Сэтгэцийн байдал &nbsp;:
                           <Form.Item shouldUpdate className="mb-0" noStyle name={['general', 'mindStatus2']}>
