      ...
      <div className="page">
         <div className="subpage">
            ...
            >
               ...
               <span style={{ fontWeight: 'bold', fontSize: 12 }}>Эрүүл мэндийн бүртгэлийн маягт АМ-9B</span>
            </div>
            <div style={{ textAlign: 'center', marginTop: 10, marginBottom: 15 }}>
               <span style={{ fontWeight: 'bold', fontSize: 14 }}>Сэтгэцэд нөлөөт эмийн жорын маягт</span>
            </div>
            <div
               style={{
                  display: 'flex',
               ...
               >
                  <div className="cross">
                     ...
                     <div style={{ borderWidth: 1, borderStyle: 'solid' }}>
                        ...
                        >
                           <span style={{ fontWeight: 'bold', fontSize: 14 }}>Сэтгэцэд нөлөөт эмийн жор</span>
                        </div>
               ...
               >
                  ...
                  >
                     <span style={{ fontSize: 12, paddingTop: 30 }}>
                        Сэтгэцэд нөлөөт эмийн жорын маягтад 2-оос илүүгүй эмийг бичих ба энэхүү жор нь бичигдсэн өдрөөс
