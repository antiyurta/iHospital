                  ...
                  <div>
                     ...
                     <div style={styles.flexRow}>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column' }}>
                           ...
                           <span style={{ fontWeight: 'bold', fontSize: 12 }}>Эрүүл мэндийн бүртгэлийн маягт АМ-6</span>
                        </div>
                     </div>
                  </div>
               </div>
               <div style={{ textAlign: 'center', marginTop: 5, marginBottom: 10 }}>
                  <span style={{ fontWeight: 'bold', fontSize: 16 }}>ГЕМОДИАЛИЗ ХЯНАЛТЫН КАРТ</span>
               </div>
               <Table bordered className="document" style={{ marginBottom: 0 }}>
                  <tbody>
                     <tr>
                        <td style={{ ...styles.topText, ...{ width: 200 } }} rowSpan={4} colSpan={2}>
                           Эмнэлгийн нэр, лого
                        </td>
                     ...
                     <tr>
                        <td style={{ ...styles.topText, ...{ width: 200 } }} colSpan={2}>
                     ...
                     <tr>
                        <td style={styles.topText}>Төрсөн _______Он ____сар ____өдөр</td>
                     ...
                     <tr>
                        ...
                        <td style={styles.topText} colSpan={2}>
                           ...
                           <div style={styles.leftText}>БАД эхэлсэн: ______ он ____ сар ____ өдөр</div>
                           <div style={styles.leftText}>Гемодиализ эхэлсэн: ____ он __ сар ___ өдөр</div>
                           <div style={styles.leftText}>АВ фистул: _____ он ____ сар ___ өдөр</div>
                        </td>
                     </tr>
                     <tr>
                        <td style={styles.topText} colSpan={2}>
         ...
         <div className="page">
            <div className="subpage">
               ...
               <Table bordered className="document" style={{ marginBottom: 0 }}>
                  <tbody>
                     <tr>
                        <td style={{ ...styles.topText, ...{ height: 200 } }}>Өвчний түүх:</td>
                     </tr>
                     <tr>
                        <td style={{ ...styles.topText, ...{ height: 200 } }}>Амьдралын түүх:</td>
                     </tr>
                     <tr>
                        <td style={{ ...styles.topText, ...{ height: 200 } }}>
                           ...
                           <div>&nbsp;</div>
                           <div>&nbsp;</div>
                           <div style={styles.leftText}>Урьд өвчилсөн өвчин эмгэгийн байдал:</div>
                           <div>&nbsp;</div>
                           <div>&nbsp;</div>
                           <div>&nbsp;</div>
            ...
            <div className="subpage">
               <Table bordered className="document" style={{ marginBottom: 0 }}>
                  <tbody>
                     ...
                     <tr>
                        <td style={styles.topText} colSpan={25}>
                           Диализын оролт /7 хоногт ........................ удаа ................ цаг/
                           <div style={styles.leftText}>Бикарбонатын, ацетатны</div>
                           <div>&nbsp;</div>
                           <div style={styles.leftText}>
                              Холболт: A-V фистула, дабль гуурс, тунель гуурс, байнгын гуурс
                           </div>
                           <div>&nbsp;</div>
                        </td>
                     </tr>
                     <tr>
                        <td style={{ ...styles.topText, ...{ width: 200 } }}>_______Он ____сар ____өдөр</td>
                     ...
                     <tr>
                        <td style={{ ...styles.centerText, ...{ height: 100 } }}>Клиник шинж тэмдэг</td>
                        <td style={styles.topText} colSpan={4}></td>
                        <td style={styles.topText} colSpan={4}></td>
                        <td style={styles.topText} colSpan={4}></td>
                        <td style={styles.topText} colSpan={4}></td>
                     ...
                     <tr>
                        <td style={{ ...styles.centerText, ...{ height: 80 } }}>Эмийн эмчилгээ</td>
                        <td style={styles.topText} colSpan={4}></td>
                        <td style={styles.topText} colSpan={4}></td>
                        <td style={styles.topText} colSpan={4}></td>
                        <td style={styles.topText} colSpan={4}></td>
