         ...
         <div className="subpage-landscape">
            <div>
               ...
               >
                  ...
                  <span style={{ fontWeight: 'bold', fontSize: 12 }}>Эрүүл мэндийн бүртгэлийн маягт АМ-23</span>
               </div>
               <div style={{ textAlign: 'center' }}>
                  <span style={{ fontWeight: 'bold', fontSize: 16 }}>ЛАБОРАТОРИЙН ШИНЖИЛГЭЭНИЙ БҮРТГЭЛ</span>
               </div>
               <div
                  style={{
                     display: 'flex',
