      ...
      <>
         <div className="page">
            <div className="subpage">
               ...
               <div style={{ fontSize: 12, marginTop: 5 }}>
                  9. Мэргэжил __________________________________ 10. Боловсрол:
                  /зур/ Боловсролгүй, Бага, Бүрэн дунд
               </div>
               <div style={{ fontSize: 12, marginTop: 5 }}>
                  Мэргэжлийн болон техникийн, Дипломын, Бакалавр, Магистр,
                  Доктор
               </div>
               <div style={{ fontSize: 12, marginTop: 5 }}>
                  10. Карт нээсэн _______ он ___ сар ___ өдөр хаасан _______ он
                  ____ сар ____ өдөр
               </div>
