        ...
        <div className="page">
            <div className="flex flex-wrap">
                <div className="w-full amaraZuun amaraBaruun amaraDeer">
                    <p className="text-center font-bold">Чихрийн шижингийн үзлэг</p>
                </div>
                <div className="w-5/12 amaraZuun amaraDeer">
                    <p className="ml-2 font-bold">Чихрийн шижингийн эрсдэлт хүчин зүйлс:</p>
                    <Form.Item
                        name={['Чихрийн шижингийн үзлэг', "Чихрийн шижингийн эрсдэлт хүчин зүйлс"]}
                        className="mb-0"
                    >
                        <Checkbox.Group className="ddd ml-0 grid">
                            <Checkbox className="ml-1" value={"Тарган удам"}>Тарган удам</Checkbox>
                            <Checkbox className="ml-1" value={"ЧШ-гийн удам"}>ЧШ-гийн удам</Checkbox>
                            <Checkbox className="ml-1" value={"Жин (хамгийн их)"}>Жин (хамгийн их)</Checkbox>
                            <Checkbox className="ml-1" value={"Гепатит"}>Гепатит</Checkbox>
                            <Checkbox className="ml-1" value={"Панкреатит"}>Панкреатит</Checkbox>
                            <Checkbox className="ml-1" value={"Жирэмсний ЧШ"}>Жирэмсний ЧШ</Checkbox>
                            <Checkbox className="ml-1" value={"4 кг дээш хүүхэд"}>4 кг дээш хүүхэд</Checkbox>
                            <Checkbox className="ml-1" value={"Архи"}>Архи</Checkbox>
                            <Checkbox className="ml-1" value={"Тамхи"}>Тамхи</Checkbox>
                            <Checkbox className="ml-1" value={"Хоолны дэглэм: сайн /дунд/ муу"}>Хоолны дэглэм: сайн /дунд/ муу</Checkbox>
                            <Checkbox className="ml-1" value={"Хөдөлгөөн: сайн /дунд/ муу"}>Хөдөлгөөн: сайн /дунд/ муу</Checkbox>
                        </Checkbox.Group>
                    </Form.Item>
                </div>
                <div className="w-7/12 amaraZuun amaraDeer amaraBaruun">
                    <p className="ml-2 font-bold">Оношлогдсон он: {form.getFieldValue(['Чихрийн шижингийн үзлэг', 'Оношлогдсон он'])}</p>
                    <p className="ml-2 font-bold">Хэрэглэдэг эмийн бэлдмэл: {form.getFieldValue(['Чихрийн шижингийн үзлэг', 'Хэрэглэдэг эмийн бэлдмэл'])}</p>
                </div>
                <div className="w-4/12 amaraZuun amaraDeer">
                    ...
                    <p>
                        <div className="inline-flex">
                            ...
                            <p className="ml-2 underline">{form.getFieldValue(['Чихрийн шижингийн үзлэг', 'Жин'])}</p>
                    ...
                    <p>
                        <div className="inline-flex">
                            ...
                            <p className="ml-2 underline">{form.getFieldValue(['Чихрийн шижингийн үзлэг', 'Өндөр'])}</p>
                    ...
                    <p>
                        <div className="inline-flex">
                            ...
                            <p className="ml-2 underline">{form.getFieldValue(['Чихрийн шижингийн үзлэг', 'Биеийн өөхний хэмжээ'])}</p>
                            <p className="ml-2">%</p>
                        </div>
                    ...
                    <p>
                        <div className="inline-flex">
                            ...
                            <p className="ml-2 underline">{form.getFieldValue(['Чихрийн шижингийн үзлэг', 'Бүсэлхийн тойрог'])}</p>
                            <p className="ml-2">см</p>
                        </div>
                        <p className="text-center">{"Ази - эр<94см; эм<80см"}</p>
                        <p className="text-center">{"Европ - эр<102см; эм<88см"}</p>
                    </p>
                </div>
                <div className="w-8/12 amaraZuun amaraDeer amaraBaruun">

                </div>
                <div className="w-full text-center amaraDeer amaraZuun amaraBaruun">
                    <div className="inline-flex">
                        <p>Биеийн жингийн индекс(БЖИ)</p>
                        <p className="ml-2 underline">{form.getFieldValue(['Чихрийн шижингийн үзлэг', 'Биеийн жингийн индекс (БЖИ)'])}</p>
                        <p>кг/м2</p>
                    </div>
                </div>
                ...
                <div className="w-full amaraDeer amaraZuun amaraBaruun">
                    <p className="text-center font-bold">Чихрийн шижингийн хяналт</p>
                </div>
                <div className="w-full amaraDeer amaraZuun amaraBaruun">
                ...
                <div className="w-9/12 amaraDeer amaraZuun amaraBaruun">
                    <p className="ml-2">{form.getFieldValue(['Чихрийн шижингийн хяналт', 'Өлөн үеийн глюкоз (<6.0 ммоль/л)'])}</p>
                </div>
                <div className="w-3/12 amaraDeer amaraZuun">
                ...
                <div className="w-9/12 amaraDeer amaraZuun amaraBaruun">
                    <p className="ml-2">{form.getFieldValue(['Чихрийн шижингийн хяналт', 'Хоолны дараах глюкоз (<8.0 ммоль/л)'])}</p>
                </div>
                <div className="w-3/12 amaraDeer amaraZuun">
                    <p>|</p>
                </div>
                ...
                <div className="w-full text-center amaraDeer amaraZuun amaraBaruun">
                    <div className="inline-flex">
                        ...
                        <p className="ml-2 underline">{form.getFieldValue(['Чихрийн шижингийн хяналт', 'HbA1C'])}</p>
                        <p className="ml-2">%</p>
                    </div>
                </div>
                ...
                <div className="w-1/2 amaraDeer amaraZuun">
                    ...
                    <p className="ml-2 underline">{form.getFieldValue(['Чихрийн шижингийн хяналт', 'Anti- GAD/IA2'])}</p>
                </div>
                <div className="w-1/2 amaraDeer amaraZuun amaraBaruun">
                    ...
                    <p>
                        <div className="inline-flex">
                            ...
                            <p className="ml-2 underline">{form.getFieldValue(['Чихрийн шижингийн хяналт', 'Өлөн үеийн глюкоз'])}</p>
                    ...
                    <p>
                        <div className="inline-flex">
                            ...
                            <p className="ml-2 underline">{form.getFieldValue(['Чихрийн шижингийн хяналт', '2 цагийн дараах глюкоз'])}</p>
                ...
                <div className="w-full amaraDeer amaraZuun amaraBaruun">
                    <p>
                        <div className="inline-flex">
                            ...
                            <p className="ml-2 underline">{form.getFieldValue(['Чихрийн шижингийн хяналт', 'Чихрийн шижингийн хүндрнл (Нүд)'])}</p>
                        </div>
                    </p>
                    <p>
                        <div className="inline-flex">
                            <p className="ml-2">Зүрх:</p>
                            <p className="ml-2 underline">{form.getFieldValue(['Чихрийн шижингийн хяналт', 'Чихрийн шижингийн хүндрнл (Зүрх)'])}</p>
                        </div>
                    </p>
                </div>
                <div className="w-3/12 amaraDeer amaraZuun">
                ...
                <div className="w-6/12 amaraDeer amaraZuun">
                    <p className="ml-2">{form.getFieldValue(['Чихрийн шижингийн хяналт', 'Холестерол'])}</p>
                </div>
                <div className="w-3/12 amaraDeer amaraZuun amaraBaruun">
                ...
                <div className="w-6/12 amaraDeer amaraZuun">
                    <p className="ml-2">{form.getFieldValue(['Чихрийн шижингийн хяналт', 'БНЛП'])}</p>
                </div>
                <div className="w-3/12 amaraDeer amaraZuun amaraBaruun">
                ...
                <div className="w-6/12 amaraDeer amaraZuun">
                    <p className="ml-2">{form.getFieldValue(['Чихрийн шижингийн хяналт', 'Триглицерид'])}</p>
                </div>
                <div className="w-3/12 amaraDeer amaraZuun amaraBaruun">
                ...
                <div className="w-6/12 amaraDeer amaraZuun">
                    <p className="ml-2">{form.getFieldValue(['Чихрийн шижингийн хяналт', 'ИНЛП-с бусад'])}</p>
                </div>
                <div className="w-3/12 amaraDeer amaraZuun amaraBaruun">
                ...
                <div className="w-6/12 amaraDeer amaraZuun">
                    <p className="ml-2">{form.getFieldValue(['Чихрийн шижингийн хяналт', 'Холест/ИНЛП'])}</p>
                </div>
                <div className="w-3/12 amaraDeer amaraZuun amaraBaruun">
                ...
                <div className="w-full amaraDeer amaraZuun amaraBaruun amaraDoor">
                    <div className="inline-flex">
                        ...
                        <p className="ml-2 underline">{form.getFieldValue(['Чихрийн шижингийн хяналт', 'CRP'])}</p>
