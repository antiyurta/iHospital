            ...
            <div className="flex flex-wrap">
                ...
                <div className="w-4/12 amaraDeer amaraZuun">
                    ...
                    >
                        <Checkbox.Group className="ddd mx-auto">
                            ...
                            <Checkbox className="ml-0" value={"Маш хүнд"}>Маш хүнд</Checkbox>
                        </Checkbox.Group>
                    </Form.Item>
                </div>
                <div className="w-4/12 amaraDeer amaraZuun">
                    <Form.Item
                        name={['Ерөнхий', "Ухаан санаа"]}
                        className="mb-0"
                    >
                        <Checkbox.Group className="ddd ml-0">
                            <Checkbox value={"Саруул"}>Саруул</Checkbox>
                            <Checkbox value={"Бүдгэрсэн"}>Бүдгэрсэн</Checkbox>
                            <Checkbox className="ml-0" value={"Ухаангүй"}>Ухаангүй</Checkbox>
                        </Checkbox.Group>
                    </Form.Item>
                </div>
                <div className="w-4/12 amaraDeer amaraZuun amaraBaruun">
                    <Form.Item
                        name={['Ерөнхий', "Арьс салст"]}
                        className="mb-0"
                    >
                        <Checkbox.Group className="ddd ml-0">
                ...
                <div className="w-2/12 amaraDeer amaraZuun">
                    ...
                    <div className="inline-flex">
                        ...
                        <p className="pr-1 underline">{form.getFieldValue(['Цусны эргэлтийн тогтолцоо', "Судасны цохилт 1 минутанд"])}</p>
                        <p>удаа</p>
                    </div>
                    <div className="inline-flex">
                        <p className="pr-1">Хүчдэл дүүрэлт</p>
                        <p className="pr-1 underline">{form.getFieldValue(['Цусны эргэлтийн тогтолцоо', "Хүчдэл дүүргэлт"])}</p>
                    </div>
                </div>
                <div className="w-3/12 amaraDeer amaraZuun">
                    ...
                    >
                        <Checkbox.Group className="ddd ml-0">
                            <Checkbox className="ml-2" value={"Хэвийн"}>Хэвийн</Checkbox>
                ...
                <div className="w-7/12 amaraDeer amaraZuun amaraBaruun">
                    ...
                    >
                        <Checkbox.Group className="ddd ml-0">
                            <Checkbox className="ml-2" value={"Тод"}>Тод</Checkbox>
                    ...
                    <div className="inline-flex">
                        ...
                        <p className="ml-2 underline">{form.getFieldValue(['Цусны эргэлтийн тогтолцоо', "АД баруун талд"])}</p>
                        <p className="ml-2">Зүүн талд</p>
                        <p className="ml-2 underline">{form.getFieldValue(['Цусны эргэлтийн тогтолцоо', "АД зүүн талд"])}</p>
                    </div>
                </div>
                <div className="w-full amaraDeer amaraZuun amaraBaruun">
                ...
                <div className="w-4/12 amaraDeer amaraZuun">
                    ...
                    >
                        <Checkbox.Group className="ddd ml-0">
                            <Checkbox className="ml-2" value={"Ердийн"}>Ердийн</Checkbox>
                ...
                <div className="w-8/12 amaraDeer amaraZuun amaraBaruun">
                    <div className="inline-flex">
                        ...
                        >
                            <Checkbox.Group className="ddd ml-0">
                                <Checkbox className="ml-1" value={"Гүн тэмтрэлтээр"}>Гүн тэмтрэлтээр</Checkbox>
                    ...
                    >
                        <Checkbox.Group className="ddd ml-0">
                            <Checkbox className="" value={"Өнгөргүй"}>Ердийн</Checkbox>
                            <Checkbox value={"Өнгөртэй"}>Зөөлөн гялтан цочрол үгүй</Checkbox>
                            <Checkbox value={"Өнгөртэй"}><p style={{ width: 150 }}>Гялтан цочролын шинж илэрсэн</p></Checkbox>
                        </Checkbox.Group>
                    </Form.Item>
                </div>
                <div className="w-full amaraDeer amaraZuun amaraBaruun">
                ...
                <div className="w-6/12 amaraDeer amaraZuun">
                    <div className="inline-flex">
                        ...
                        >
                            <Checkbox.Group className="ddd ml-0">
                                <Checkbox className="ml-1" value={"Хэвийн"}>Хэвийн</Checkbox>
                                <Checkbox className="ml-1" value={"Буурсан"}>Буурсан(баруун,зүүн)</Checkbox>
                            </Checkbox.Group>
                        </Form.Item>
                    </div>
                </div>
                <div className="w-6/12 amaraDeer amaraZuun amaraBaruun">
                    <div className="inline-flex">
                        ...
                        >
                            <Checkbox.Group className="ddd ml-0">
                                <Checkbox className="ml-1" value={"Хадгалагдана"}>Хадгалагдана</Checkbox>
                ...
                <div className="w-full amaraDeer amaraZuun amaraBaruun">
                    <p className="ml-2">Бусад:{form.getFieldValue(['Мэдрэлийн тогтолцоо', "Бусад"])}</p>
                    <p className="ml-2">Сэтгэцийн байдал:{form.getFieldValue(['Мэдрэлийн тогтолцоо', "Сэтгэцийн байдал"])}</p>
                </div>
                <div className="w-full amaraDeer amaraZuun amaraBaruun">
                ...
                <div className="w-5/12 amaraDeer amaraZuun amaraBaruun">
                    ...
                    <Form.Item
                        name={['Дотоод шүүрэл судлалын үзлэг', "Бамбайн томролын зэрэг"]}
                        className="mb-0"
                    >
                        <Checkbox.Group className="ddd ml-0">
                            <Checkbox className="ml-1" value={"0-р зэрэг (Харагдахгүй, тэмтрэгдэнэ)"}>0-р зэрэг (Харагдахгүй, тэмтрэгдэнэ)</Checkbox>
                            <Checkbox className="ml-1" value={"1-р зэрэг (Харагдахгүй, тэмтрэгдэнэ)"}>1-р зэрэг (Харагдахгүй, тэмтрэгдэнэ)</Checkbox>
                            <Checkbox className="ml-1" value={"2-р зэрэг (Харагдахгүй, тэмтрэгдэнэ)"}>2-р зэрэг (Харагдахгүй, тэмтрэгдэнэ)</Checkbox>
                        </Checkbox.Group>
                    </Form.Item>
                </div>
                <div className="w-3/12 amaraDeer amaraZuun">
                    ...
                    >
                        <Checkbox.Group className="ddd ml-0">
                            <Checkbox className="ml-1" value={"Крауссийн шинж"}>Крауссийн шинж</Checkbox>
                            <Checkbox className="ml-1" value={"Грефийн шинж"}>Грефийн шинж</Checkbox>
                            <Checkbox className="ml-1" value={"Кохерийн шинж"}>Кохерийн шинж</Checkbox>
                            <Checkbox className="ml-1" value={"Мебиусийн шинж"}>Мебиусийн шинж</Checkbox>
                        </Checkbox.Group>
                    </Form.Item>
                </div>
                <div className="w-3/12 amaraDeer amaraZuun">
                    ...
                    >
                        <Checkbox.Group className="ddd ml-0">
                            <Checkbox className="ml-1" value={"Штельвагийн шинж"}>Штельвагийн шинж</Checkbox>
                            <Checkbox className="ml-1" value={"Дельримплийн шинж"}>Дельримплийн шинж</Checkbox>
                            <Checkbox className="ml-1" value={"Еленикийн шинж"}>Еленикийн шинж</Checkbox>
                            <Checkbox className="ml-1" value={"Розенбахын шинж"}>Розенбахын шинж</Checkbox>
                            <Checkbox className="ml-1" value={"Боткиний шинж"}>Боткиний шинж</Checkbox>
                            <Checkbox className="ml-1" value={"Жоффруагийн шинж"}>Жоффруагийн шинж</Checkbox>
                        </Checkbox.Group>
                    </Form.Item>
                </div>
                <div className="w-6/12 amaraDeer amaraZuun amaraBaruun">
                    <p className="ml-2">Марийн шинж</p>
                    <p className="ml-2 underline">{form.getFieldValue(['Дотоод шүүрэл судлалын үзлэг', "Марийн шинж"])}</p>
                    <p className="ml-2">Цахилгаан бүхээгний шинж</p>
                    <p className="ml-2 underline">{form.getFieldValue(['Дотоод шүүрэл судлалын үзлэг', "Цахилгаан бүхээгний шинж"])}</p>
                    <p className="ml-2">Дермографизм (улаан, түргэн тогтвортой)</p>
                    <p className="ml-2 underline">{form.getFieldValue(['Дотоод шүүрэл судлалын үзлэг', "Дермографизм (улаан, түргэн тогтвортой)"])}</p>
                </div>
                        ...
                        <div className="w-7/12">
                            <div className="flex flex-wrap">
                                ...
                                <div className="w-full amaraDeer amaraZuun amaraDoor amaraBaruun">
                                    ...
                                    <p className="ml-2 underline">{form.getFieldValue(['Дотоод шүүрэл судлалын үзлэг', "Бамбайн цөмийн изотоп шинжилгээ"])}</p>
                                    <p className="ml-2 font-bold">Бамбайн эсийн шинжилгээ:</p>
                                    <p className="ml-2 underline">{form.getFieldValue(['Дотоод шүүрэл судлалын үзлэг', "Бамбайн эсийн шинжилгээ"])}</p>
                                </div>
                            </div>
                        </div>
                    </div>
