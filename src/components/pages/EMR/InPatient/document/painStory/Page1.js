         ...
         <div className="flex flex-wrap">
            ...
            <div className="w-5/12">
               <div className="flex flex-wrap">
                  ...
                  <div className="w-10/12 amaraDeer amaraZuun amaraBaruun"></div>
                  <div className="w-2/12 amaraDeer amaraZuun">
                     <p>НДД</p>
                  </div>
                  <div className="w-10/12 amaraDeer amaraZuun amaraBaruun"></div>
            ...
            <div className="w-2/12 amaraDeer amaraZuun">
               ...
               <Checkbox.Group
                  className="ddd ml-0"
                  defaultValue={[patient.genderType]}
               >
            ...
            <div className="w-3/12 amaraDeer amaraZuun">
               ...
               <Checkbox.Group
                  className="ddd ml-0"
                  defaultValue={[patient.educationType]}
               >
            ...
            <div className="w-3/12 amaraDeer amaraZuun amaraBaruun">
               ...
               <Checkbox
                  className="w-full"
                  defaultChecked={anemis.allergy.isFood ? true : false}
               >
                  Хоол хүнс
               </Checkbox>
               <Checkbox
            ...
            <div className="w-full amaraDeer amaraZuun amaraBaruun">
               <p className="inline-flex">
                  <p className="ml-2 font-extrabold w-max whitespace-nowrap">
                     Хэвтэх үеийн онош
                  </p>
            ...
            <div className="w-3/12 amaraDeer amaraZuun amaraBaruun">
               ...
               <p className="text-center">
                  {moment(diagnose.mainDiagnoseDate).format(
                     'YYYYон MMсар DDөдөр'
                  )}
               </p>
            </div>
            ...
            <div className="w-3/12 amaraDeer amaraZuun amaraBaruun"></div>
            <div className="w-9/12 amaraDeer amaraZuun">
