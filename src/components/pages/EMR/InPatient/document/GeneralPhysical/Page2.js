                     ...
                     <td className="w-48">
                        ...
                        <Form.Item name={['Цусны эргэлтийн тогтолцоо', 'Тогшилтоор']} className="mb-0">
                           <Checkbox.Group className="ddd ml-0">
                              ...
                              <Checkbox value={'Томорсон (зүүн, баруун)'}>Ногоон</Checkbox>
                              <Checkbox value={'Томорсон (зүүн, баруун)'}>Үнэртэй</Checkbox>
                              <Checkbox value={'Томорсон (зүүн, баруун)'}>Өтгөн</Checkbox>
                              <Checkbox className="w-full" value={'Томорсон (зүүн, баруун)'}>
                                 Бусад өөрчлөлттэй
                              </Checkbox>
                           </Checkbox.Group>
                     ...
                     <td>
                        ...
                        <Form.Item name={['Цусны эргэлтийн тогтолцоо', 'Тогшилтоор']} className="mb-0">
                           <Checkbox.Group className="ddd ml-0">
                              ...
                              <Checkbox value={'Томорсон (зүүн, баруун)'}>Хавантай</Checkbox>
                           </Checkbox.Group>
                        </Form.Item>
                     </td>
                     <td>
                     ...
                     <td>
                        ...
                        <Form.Item name={['Цусны эргэлтийн тогтолцоо', 'Тогшилтоор']} className="mb-0">
                           <Checkbox.Group className="ddd ml-0">
                              ...
                              <Checkbox value={'Томорсон (зүүн, баруун)'}>Цүлхийсэн (аль хана)</Checkbox>
                           </Checkbox.Group>
                        </Form.Item>
                     </td>
                  </tr>
                     ...
                     <td>
                        ...
                        <Form.Item name={['Цусны эргэлтийн тогтолцоо', 'Тогшилтоор']} className="mb-0">
                           <Checkbox.Group className="ddd ml-0">
                              ...
                              <Checkbox value={'Томорсон (зүүн, баруун)'}>Хязгаарлагдсан</Checkbox>
                           </Checkbox.Group>
                        </Form.Item>
                        <p>Хүүхэн хэл:</p>
                        <Form.Item name={['Цусны эргэлтийн тогтолцоо', 'Тогшилтоор']} className="mb-0">
                     ...
                     <td colSpan={2}>
                        ...
                        <Form.Item name={['Цусны эргэлтийн тогтолцоо', 'Тогшилтоор']} className="mb-0">
                           <Checkbox.Group className="ddd ml-0">
                              ...
                              <Checkbox value={'Томорсон (зүүн, баруун)'}>2-р зэрэг</Checkbox>
                              <Checkbox className="ml-2" value={'Хэвийн'}>
                                 3-р зэрэг
                              </Checkbox>
