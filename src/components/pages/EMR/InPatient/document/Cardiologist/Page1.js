                     ...
                     <td rowSpan={2}>
                        ...
                        <Form.Item name={['Цусны эргэлтийн тогтолцоо', 'Тогшилтоор']} className="mb-0">
                           <Checkbox.Group className="ddd ml-0">
                              ...
                              <Checkbox value={'Томорсон (зүүн, баруун)'}>Зүүн талд: _____/_____мм.муб</Checkbox>
                           </Checkbox.Group>
                        </Form.Item>
                        <p>Зүрхний авиа</p>
                        ...
                        <div className="inline-flex">
                           ...
                           <Form.Item name={['Цусны эргэлтийн тогтолцоо', 'Тогшилтоор']} className="mb-0">
                              <Checkbox.Group className="ddd ml-0">
                                 ...
                                 <Checkbox value={'Томорсон (зүүн, баруун)'}>Бүдгэвтэр(I,IV цэгт)</Checkbox>
                                 <Checkbox className="ml-2" value={'Хэвийн'}>
                                    Бүдэг(I,IV)
                                 </Checkbox>
                                 <Checkbox value={'Томорсон (зүүн, баруун)'}>Чангарсан(I,IV цэгт)</Checkbox>
                              </Checkbox.Group>
                           </Form.Item>
                        </div>
                        <div className="inline-flex">
                           ...
                           <Form.Item name={['Цусны эргэлтийн тогтолцоо', 'Тогшилтоор']} className="mb-0">
                              <Checkbox.Group className="ddd ml-0">
                                 ...
                                 <Checkbox value={'Томорсон (зүүн, баруун)'}>Чангарсан(II,III цэгт)</Checkbox>
                              </Checkbox.Group>
                           </Form.Item>
                        </div>
                     </td>
                     ...
                     <td>
                        ...
                        <Form.Item name={['Цусны эргэлтийн тогтолцоо', 'Тогшилтоор']} className="mb-0">
                           <Checkbox.Group className="ddd ml-0">
                              ...
                              <Checkbox value={'Томорсон (зүүн, баруун)'}>Ажиглагдана (хүчтэй, дунд, сул)</Checkbox>
                           </Checkbox.Group>
                        </Form.Item>
                        ...
                        <Form.Item name={['Цусны эргэлтийн тогтолцоо', 'Тогшилтоор']} className="mb-0">
                           <Checkbox.Group className="ddd ml-0">
                              ...
                              <Checkbox value={'Томорсон (зүүн, баруун)'}>Ажиглагдахгүй</Checkbox>
                           </Checkbox.Group>
                        </Form.Item>
                     </td>
                  </tr>
