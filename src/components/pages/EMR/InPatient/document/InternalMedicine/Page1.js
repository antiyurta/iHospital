               ...
               <thead>
                  ...
                  <tr>
                     <th>
                        ...
                        <p>чөлөөтэй эсэх:</p>
                        <Form.Item
                           name={['doctorInspection', 'ct1IM1.1.1']}
                           shouldUpdate
                           className="mb-0"
                           noStyle
                        >
                        ...
                        <Form.Item
                           name={['doctorInspection', 'ct1IM1.1.2']}
                           shouldUpdate
                           className="mb-0"
                           noStyle
                        >
                        ...
                        <p>Тийм бол:</p>
                        <Form.Item
                           name={['doctorInspection', 'ct1IM1.1.3']}
                           shouldUpdate
                           className="mb-0"
                           noStyle
                        >
                     ...
                     <th>
                        ...
                        <p>байгаа эсэх:</p>
                        <Form.Item
                           name={['doctorInspection', 'ct1IM1.1.4']}
                           shouldUpdate
                           className="mb-0"
                           noStyle
                        >
                        ...
                        <Form.Item
                           ...
                           className="mb-0"
                           noStyle
                           name={['doctorInspection', 'ct1IM1.1.6']}
                        >
                           <Checkbox.Group className="ml-0">
                     ...
                     <th>
                        ...
                        <Form.Item
                           ...
                           className="mb-0"
                           noStyle
                           name={['doctorInspection', 'ct1IM1.1.7']}
                        >
                           <Checkbox.Group className="ml-0">
                              <Checkbox className="ml-2 w-full" value={0}>
                                 Зөв
                        ...
                        <Form.Item
                           ...
                           className="mb-0"
                           noStyle
                           name={['doctorInspection', 'ct1IM1.1.8']}
                        >
                           <Checkbox.Group className="ml-0">
                              <Checkbox className="ml-2 w-full" value={0}>
                                 Цээжний
                     ...
                     <th>
                        ...
                        <Form.Item
                           ...
                           className="mb-0"
                           noStyle
                           name={['doctorInspection', 'ct1IM1.1.9']}
                        >
                           <Checkbox.Group className="ml-0">
                              <Checkbox className="ml-2" value={0}>
                                 Жигд(баруун/зүүн)
                  ...
                  <tr>
                     <th>
                        ...
                        <Form.Item
                           ...
                           className="mb-0"
                           noStyle
                           name={['doctorInspection', 'ct1IM1.2.1']}
                        >
                           <Checkbox.Group className="ml-0">
                              <Checkbox className="ml-2 w-full" value={0}>
                                 Эмзэглэлгүй
                        ...
                        <Form.Item
                           ...
                           className="mb-0"
                           noStyle
                           name={['doctorInspection', 'ct1IM1.2.3']}
                        >
                           <Checkbox.Group className="ml-0">
                              <Checkbox className="ml-2" value={0}>
                                 Хэвийн
                     ...
                     <th>
                        ...
                        <Form.Item
                           ...
                           className="mb-0"
                           noStyle
                           name={['doctorInspection', 'ct1IM1.2.4']}
                        >
                           <Checkbox.Group className="ml-0">
                              <Checkbox className="ml-2" value={0}>
                                 Хэвийн Суларсан
                     ...
                     <th>
                        ...
                        <Form.Item
                           ...
                           className="mb-0"
                           noStyle
                           name={['doctorInspection', 'ct1IM1.3.1']}
                        >
                           <Checkbox.Group className="ml-0">
                              <Checkbox className="ml-2" value={0}>
                                 2 талд ижил
                     ...
                     <th>
                        ...
                        <Form.Item
                           ...
                           className="mb-0"
                           noStyle
                           name={['doctorInspection', 'ct1IM1.3.2']}
                        >
                           <Checkbox.Group className="ml-0">
                              <Checkbox className="ml-2 w-full" value={0}>
                                 Бүдгэрсэн
                  ...
                  <tr>
                     <th colSpan={2}>
                        ...
                        <Form.Item
                           ...
                           className="mb-0"
                           noStyle
                           name={['doctorInspection', 'ct1IM1.4.1']}
                        >
                           <Checkbox.Group className="ml-0">
                              <Checkbox className="ml-2 w-full" value={0}>
                                 Ижил
                        ...
                        <Form.Item
                           ...
                           className="mb-0"
                           noStyle
                           name={['doctorInspection', 'ct1IM1.4.3']}
                        >
                           <Checkbox.Group className="ml-0">
                              <Checkbox className="ml-2" value={0}>
                                 Тийм
                     ...
                     <th colSpan={2}>
                        ...
                        <Form.Item
                           ...
                           className="mb-0"
                           noStyle
                           name={['doctorInspection', 'ct1IM1.4.5']}
                        >
                           <Checkbox.Group className="ml-0">
                              <Checkbox className="ml-2" value={0}>
                                 Тийм
                        ...
                        <Form.Item
                           ...
                           className="mb-0"
                           noStyle
                           name={['doctorInspection', 'ct1IM1.4.8']}
                        >
                           <Checkbox.Group className="ml-0">
                              <Checkbox className="ml-2 w-full" value={0}>
                                 Хэвийн
                  ...
                  <tr>
                     <th>
                        <Form.Item
                           ...
                           className="mb-0"
                           noStyle
                           name={['doctorInspection', 'ct1IM2.1.1']}
                        >
                           <Checkbox.Group className="ml-0">
                              <Checkbox className="ml-2 w-full" value={0}>
                                 Зохисгүй хооллолт
                     ...
                     <th className="w-20">
                        <Form.Item
                           ...
                           className="mb-0"
                           noStyle
                           name={['doctorInspection', 'ct1IM2.1.2']}
                        >
                           <Checkbox.Group className="ml-0">
                              <Checkbox className="ml-2 w-full" value={0}>
                  ...
                  <tr>
                     <th className="w-72">
                        ...
                        <Form.Item
                           ...
                           className="mb-0"
                           noStyle
                           name={['doctorInspection', 'ct1IM2.3.1']}
                        >
                           <Checkbox.Group className="ml-0">
                              <Checkbox className="ml-2 w-full" value={0}>
                                 Хэвийн
                     ...
                     <th>
                        ...
                        <Form.Item
                           ...
                           className="mb-0"
                           noStyle
                           name={['doctorInspection', 'ct1IM2.3.5']}
                        >
                           <Checkbox.Group className="ml-0">
                              <Checkbox className="ml-2" value={0}>
                                 Дунд зэрэг
                        ...
                        <Form.Item
                           ...
                           className="mb-0"
                           noStyle
                           name={['doctorInspection', 'ct1IM2.3.7']}
                        >
                           <Checkbox.Group className="ml-0">
                              <Checkbox className="ml-2" value={0}>
                                 Ижил
                     ...
                     <th>
                        ...
                        <Form.Item
                           ...
                           className="mb-0"
                           noStyle
                           name={['doctorInspection', 'ct1IM2.4.1']}
                        >
                           <Checkbox.Group className="ml-0">
                              <Checkbox className="ml-2 w-full" value={0}>
                                 Хэвийн
                  ...
                  <tr>
                     ...
                     <th className="w-1/2">
                        ...
                        <Form.Item
                           ...
                           className="mb-0"
                           noStyle
                           name={['doctorInspection', 'ct1IM2.5.9']}
                        >
                           <Checkbox.Group className="ml-0">
                              <Checkbox className="ml-2" value={0}>
                                 Үл дамжина
                        ...
                        <Form.Item
                           ...
                           className="mb-0"
                           noStyle
                           name={['doctorInspection', 'ct1IM2.5.12']}
                        >
                           <Checkbox.Group className="ml-0">
                              <Checkbox className="ml-2" value={0}>
                                 Тийм
