      ...
      <div>
         ...
         <div className="flex flex-wrap">
            <div className="w-full basis-1/2 p-1 pr-4">
               <Form.Item label="Хэдэн онд" name={['birth', 'birthDate']}>
                  <DatePicker />
               </Form.Item>
            </div>
            <div className="w-full basis-1/2 p-1 pr-4">
               <Form.Item label="Хаана" name={['birth', 'locate']}>
                  <Input />
               </Form.Item>
            </div>
            <div className="w-full basis-1/2 p-1 pr-4">
               <Form.Item label="Яаж төрсөн" name={['birth', 'whatBorn']}>
                  <Radio.Group>
            ...
            <div className="w-full basis-1/2 p-1 pr-4">
               <Form.Item label="Хугацаандаа" name={['birth', 'stateTime']}>
            ...
            <div className="w-full basis-1/2 p-1 pr-4">
               <Form.Item label="Хэдэн 7 хоног" name={['birth', 'fewWeeks']}>
                  <InputNumber />
               </Form.Item>
            </div>
         </div>
