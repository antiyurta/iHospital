               ...
               <div className="p-1">
                  <Form.Item label="Халдварт:" name={['anemis', 'contagious']} className="mb-0">
                     <Checkbox.Group>
                        ...
                        {templateId === 2 && <Checkbox value={'mumps'}>Гахайн хавдар</Checkbox>}
                        <Checkbox value={'avirus'}>{templateId === 2 ? 'Гепатит A' : 'Вирус хепатит A'}</Checkbox>
                        <Checkbox value={'bvirus'}>{templateId === 2 ? 'Гепатит B' : 'Вирус хепатит B'}</Checkbox>
                        <Checkbox value={'cvirus'}>{templateId === 2 ? 'Гепатит C' : 'Вирус хепатит C'}</Checkbox>
                        <Checkbox value={'stomatchInfection'}>Гэдэсний халдвар</Checkbox>
                        <Checkbox className="w-full" value={'tuberculosis'}>
                           Сүрьеэ
                        </Checkbox>
                        {templateId === 2 && (
                           <>
                              <Checkbox className="ml-6 w-full" value={'1tuberculosis'}>
                                 Уушигны
                              </Checkbox>
                              <Checkbox className="ml-6 w-full" value={'2tuberculosis'}>
                                 Булчирхайн
                              </Checkbox>
                              <Checkbox className="ml-6 w-full" value={'3tuberculosis'}>
                                 Гэдэсний
                              </Checkbox>
                              <Checkbox className="ml-6 w-full" value={'4tuberculosis'}>
                                 Бусад
                              </Checkbox>
                           </>
                        )}
