...
//api
import generalInspectionApi from '@ApiServices/emr/generalInspection';
//defaults
            ...
            <Collapse
               ...
               items={[
                  ...
                  },
                  {
                     key: '2',
                     forceRender: true,
                     label: 'Амьсгалын эрхтэн тогтолцоо',
                     children: (
                        <div className="input-panel flex flex-col gap-2">
                           <Form.Item
                  ...
                  },
                  {
                     key: '3',
                     forceRender: true,
                     label: 'Цусны эргэлтийн тогтолцоо',
                     children: (
                        <div className="input-panel flex flex-col gap-2">
                           <Form.Item
