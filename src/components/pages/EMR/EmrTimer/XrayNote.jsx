...
const XrayNote = ({ patient, hospitalName, structure, note }) => {
               ...
               <div>
                  ...
                  <FlexRow>
                     ...
                     <Box top left right bottom width={'100%'}>
                        <Paragraph isBold>Дүгнэлт:</Paragraph>
                        <Paragraph>{note.conclusion?.['Дүгнэлт']}</Paragraph>
                        <Paragraph isBold>Зөвлөгөө:</Paragraph>
                        <Paragraph>{note.advice?.['Зөвлөгөө']}</Paragraph>
                     </Box>
                  </FlexRow>
               </div>
            </FlexCol>
