...
import { Button, Card, Divider, Form, Input, InputNumber, Modal, Pagination, Select, Switch, Tabs } from "antd";
...
function Medicine() {
    ...
    const medicineItems = [
        { label: "Эмийн ерөнхий мэдээлэл", key: "1", children: <GeneralDrugInformation /> },
        { label: "Худалдан авалтын мэдээлэл", key: "2", children: <PurchaseInformation /> },
