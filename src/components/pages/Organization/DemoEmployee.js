                        ...
                        <div className='table-responsive p-4' id='style-8' ref={scrollRef}>
                            <Table className='ant-border-space' style={{ width: '100%' }}>
                                <thead className='ant-table-thead bg-slate-200'>
                                    <tr>
                                        <th rowSpan={2} className="font-bold text-sm align-middle">№</th>
                                        ...
                                        <th rowSpan={2} className="font-bold text-sm align-middle">Ажилж байгаа эсэх</th>
                                        <th rowSpan={2} className="font-bold text-sm align-middle">Гэрийн хаяг</th>
                                ...
                                <tbody className='ant-table-tbody p-0'>
                                    {spinner ?
                                        employees.map((employee, index) => {
                                            return (
                                                <tr key={index}>
                                                    ...
                                                    <td className='ant-table-row-cell-break-word'>{employee.isWorking ? <CheckOutlined className='text-green-600' /> : <CloseOutlined className='text-red-600' />}</td>
                                                    <td className='ant-table-row-cell-break-word'>{employee.homeAddress}</td>
                                                    <td>
                                                        <Button type="link" onClick={() => viewModal(employee.id)} title='Харах' style={{ paddingRight: 5 }}><EyeOutlined /></Button>
                                                        <Button type="link" onClick={() => editModal(employee.id)} title='Засах' style={{ paddingRight: 5, paddingLeft: 5 }}><EditOutlined /></Button>
                                                    </td>
                                                </tr>
                                            )
                                        })
                                        :
                                        <tr>
                                            <td colSpan={7} size='lg' style={{ backgroundColor: 'white', textAlign: 'center' }}>
