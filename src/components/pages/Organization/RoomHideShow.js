   ...
   return (
      <>
         ...
         >
            ...
            <div>
               <Pagination className="pagination" pageSize={10} total={meta.itemCount} onChange={onStart} />
            </div>
         </Card>
         <Modal
            title={props.title}
         ...
         <Modal
            ...
            okText="Хадгалах"
         >
            <Form form={form} wrapperCol={{ span: 14 }} onValuesChange={handleFormValuesChange}>
               <Row gutter={[24, 6]}>
                  {props.column.map((element, index) => {
                     return (
