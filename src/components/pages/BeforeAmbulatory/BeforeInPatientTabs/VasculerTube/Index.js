...
function Index({ type, PatientData, ListId }) {
   ...
   const [pageInSize, setPageInSize] = useState(Number);
   const tubeChild = [
      {
         value: 0,
   ...
   const onFinish = async (values) => {
      ...
      const data = {
         ...
         scopingName: values.scopingName,
         tubeType: type
      };
      ...
      >
         <div className="flex flex-wrap">
            ...
            <div className="w-full p-1">
               <Spin spinning={isLoading} tip="Уншиж байна...">
                  <div ref={printRef}>
                     {vascularList?.map((element, idx) => {
                        return (
                           <div key={idx} className="page-landscape">
         ...
         >
            <Form form={form} layout="vertical">
               ...
               <Row justify="space-between" align="middle">
                  <Col span={24}>
                     <b>Тандалт хийсэн ажилтны гарын үсэг</b>
                  </Col>
               </Row>
               <Row className="mt-2">
                  <Col span={24}>
