...
function VasculerTube({ PatientData, ListId }) {
  ...
  const onFinish = async (values) => {
    ...
    const data = {
      ...
      arm: values.arm[0],
      statusArm:
        values.arm[0] === "0" || values.arm[0] === "1" ? values.arm[1] : null,
      statusFoot:
        values.arm[0] === "2" || values.arm[0] === "3" ? values.arm[1] : null,
      ...
      >
        <Form form={form} layout="vertical">
          ...
          <Row justify="space-between" align="middle">
            <Col span={24}>
              <b>
                Гуурсны үзүүрээс нян судлалын шинжилгээ авсан эсэх, илэрсэн
                үүсгэгч
              </b>
            </Col>
          </Row>
          ...
          <Row justify="space-between" align="middle">
            <Col span={24}>
              <b>
                Үрэвслийн шингэн идээнээс нян судлалын шинжилгээ авсан эсэх,
                илэрсэн үүсгэгч
              </b>
            </Col>
          </Row>
          ...
          <div ref={printRef}>
            <page size="A4" layout="landscape">
              ...
              <Table bordered className="bcp2">
                <thead>
                  <tr>
                    ...
                    <th colSpan={11}>
                      Судасны гуурсны халдварын шинж тэмдэгээр тандах хуудас
                    </th>
                  ...
                  {vascularList?.map((data, index) => {
                    return (
                      <tr key={index}>
                        ...
                        <th>
                          {data.isFever ? <PlusOutlined /> : <MinusOutlined />}
                        </th>
                        <th>
                          {data.isSystole ? (
                            <PlusOutlined />
                        ...
                        <th>
                          {data.isPulse ? <PlusOutlined /> : <MinusOutlined />}
                        </th>
                        <th>
                          {data.isUrine ? <PlusOutlined /> : <MinusOutlined />}
                        </th>
                        <th>
                          {data.isSkin ? <PlusOutlined /> : <MinusOutlined />}
                        </th>
                        <th>
                          {data.isFood ? <PlusOutlined /> : <MinusOutlined />}
                        </th>
                        <th>
                          {data.isRed ? <PlusOutlined /> : <MinusOutlined />}
                        </th>
                        <th>
                          {data.isSick ? <PlusOutlined /> : <MinusOutlined />}
                        </th>
                        <th>
                          {data.isInflamed ? (
                            <PlusOutlined />
                        ...
                        <th>
                          {data.isBumpy ? <PlusOutlined /> : <MinusOutlined />}
                        </th>
                        <th>
                          {data.isPuss ? <PlusOutlined /> : <MinusOutlined />}
                        </th>
                        <th>
                          {data.tsach ? (
                            <>
              ...
              <div style={{ display: "grid" }}>
                ...
                <span>
                  1. Хэвтсэн өдрөөс гарах өдөр хүртэл өдөрт 2 ээлж хөтлөнө.
                </span>
                <span>
                  2. Шинж тэмдэг илэрсэн /+/, илрээгүй /-/, гуурс тавьсан бол
                  /Т/, сольсон /С/, авсан /А/, өвдөлттэй /Ө/, гарсан /Г/,
                  бөгөлсөн /Б/ гэж үсгээр товчилж бичнэ.
                </span>
                <span>
                  3. Шинжилгээ авсан бол /+/, аваагүй /-/, эмгэг төрөгч илэрсэн
                  бол нэрийг нь, илрээгүй бол илрээгүй гэж бичнэ.
                </span>
              </div>
            </page>
          </div>
