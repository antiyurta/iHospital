...
function NursingNote({ PatientId, ListId, PatientData }) {
   ...
   const onUpdate = async (values) => {
      ...
      const response = await Patch('inpatient/nursing-note/' + id, token, conf, values);
      if (response === 200) {
         getNursingNote();
   ...
   return (
      ...
      >
                                 ...
                                 return (
                                    <div key={index} className="flex flex-wrap" style={{ height: 215 }}>
                                       ...
                                       <div className="basis-2/12 amaraDoor amaraBaruun">
                                          ...
                                          >
                                             {el?.issueNumber?.map((number, index) => {
                                                return (
                                                   <div key={index}>
                                                      <p
                                                         style={{
                                       ...
                                       <div className="basis-3/12 amaraDoor amaraBaruun">
                                          <p style={{ fontSize: 11 }}>{el.nursingPlan}</p>
                                       </div>
                                       <div className="basis-6/12 amaraDoor amaraBaruun">
                                          {el.conclusion === null && el.implemented === null ? (
                                             ...
                                             <>
                                                ...
                                                <p style={{ fontSize: 11 }}>{el.conclusion}</p>
                                                <p className="font-bold" style={{ fontSize: 11 }}>
                                                   Дүгнэлт:
                                                </p>
                                                <p style={{ fontSize: 11 }}>{el.implemented}</p>
                                                <p style={{ fontSize: 11 }} className="amaraDeer">
                                                   Сувилагчийн нэр:
                                                   {`${el?.createdLastName?.substr(0, 1)}. ${el?.createdFirstName}`}
                                                </p>
                                             </>
                                          )}
                                       </div>
                              ...
                              <Checkbox.Group>
                                 <div className="flex flex-wrap">
                                    <div className="basis-1/5">
                                       ...
                                       <Checkbox value={'#2'}>#2. Хийн солилцоо алдагдсан</Checkbox>
                                       <Checkbox value={'#3'}>#3. Амьсгалын замын цэвэршилт алдагдсан</Checkbox>
                                       <Checkbox value={'#4'}>#4. Хөдөлгөөний алдагдсан</Checkbox>
                                       <Checkbox value={'#5'}>#5. Ядаргаа</Checkbox>
                                       <Checkbox value={'#7'}>#7. Шокын эрсдэл</Checkbox>
                                       <Checkbox value={'#8'}>
                                          #8. Захын мэдрэлийн үйл ажиллагаа алдагдах эрсдэл
                                       </Checkbox>
                                       <Checkbox value={'#9'}>#9. Нойр хулжих</Checkbox>
                                       <Checkbox value={'#10'}>#10. Нойргүйдэл</Checkbox>
                                       <Checkbox value={'#11'}>
                                    ...
                                    <div className="basis-1/5">
                                       ...
                                       <Checkbox value={'#13'}>#13. Амны салст бүрхүүл гэмтсэн</Checkbox>
                                       <Checkbox value={'#14'}>
                                          #14. Хоол тэжээлийн тэнцвэр алдагдсан: Бие махбодид шаардлагатай хэмжээнээс их
                                       </Checkbox>
                                       <Checkbox value={'#15'}>
                                          #15. Хоол тэжээлийн тэнцвэр алдагдсан: Бие махбодид шаардлагатай хэмжээнээс
                                          бага
                                       </Checkbox>
                                       <Checkbox value={'#16'}>#16. Залгих чадварын алдагдал</Checkbox>
                                       <Checkbox value={'#17'}>#17. Бөглөрөх эрсдэл</Checkbox>
                                       <Checkbox value={'#18'}>#18. Бөөлжис цутгах</Checkbox>
                                       <Checkbox value={'#19'}>#19. Шингэний хэмжээ ихсэлт</Checkbox>
                                       <Checkbox value={'#20'}>#20. Шингэний дутагдал</Checkbox>
                                    </div>
                                    <div className="basis-1/5">
                                       <Checkbox className="ml-2" value={'#21'}>
                                          #21. Өтгөн хаталт
                                       </Checkbox>
                                       <Checkbox value={'#22'}>#22. Суулгалт</Checkbox>
                                       <Checkbox value={'#23'}>#23. Агаарын солилцооны алдагдал</Checkbox>
                                       <Checkbox value={'#24'}>
                                          #24. Цусан дахь сахарын хэмжээ тогтворгүйжих эрсдэл
                                       </Checkbox>
                                       <Checkbox value={'#25'}>#25. Шээс алдалт</Checkbox>
                                    ...
                                    <div className="basis-1/5">
                                       ...
                                       <Checkbox value={'#32'}>#32. Тодосгогч бодисонд харшлах</Checkbox>
                                       <Checkbox value={'#33'}>#33. Халуурах</Checkbox>
                                       <Checkbox value={'#34'}>#34. Халуун буурах</Checkbox>
                                       <Checkbox value={'#35'}>#35. Будилуу болох (цочмог, архаг)</Checkbox>
                                       <Checkbox value={'#36'}>#36. Ой санамж муудсан</Checkbox>
                                       <Checkbox value={'#37'}>#37. Ярих чадвар саатсан</Checkbox>
                                       <Checkbox value={'#38'}>#38. Тархины дасан зохицох чадвар буурсан</Checkbox>
                                       <Checkbox value={'#39'}>#39. Өвдөлт</Checkbox>
                                       <Checkbox value={'#40'}>#40. Сэтгэл түгших</Checkbox>
                                       <Checkbox className="w-full" value={'#41'}>
                                          #41. Айдас
                                       </Checkbox>
                                    </div>
                                    <div className="basis-1/5">
                                       ...
                                       <Checkbox value={'#43'}>#43. Итгэл алдарсан</Checkbox>
                                       <Checkbox value={'#44'}>#44. Ганцаардах эрсдэл</Checkbox>
                                       <Checkbox value={'#45'}>#45. Өөрийгөө зөв үнэлж чадахгүй болсон</Checkbox>
                                       <Checkbox value={'#46'}>#46. ЭМБ-ын мэдлэг олгох шаардлагатай</Checkbox>
                                       <Checkbox value={'#47'}>
                                          #47. Хувийн эрүүл мэндээ зохицуулах чадваргүй болсон
                                       </Checkbox>
                                       <Checkbox value={'#48'}>#48. Мэдлэгийн дутагдал</Checkbox>
                                       <Checkbox value={'#49'}>
                                          #49. Өөрийгөө асрах чадваргүй болсон (усанд орох, хувцаслах, хооллох,бие
                                          засах)
                                       </Checkbox>
                                       <Checkbox value={'#50'}>#50. Алхах чадвар алдагдсан</Checkbox>
                                    </div>
                                 </div>
                              </Checkbox.Group>
                           </Form.Item>
         ...
         <Modal
            ...
            open={isOpenSecond}
            onOk={() => secondForm.validateFields().then((values) => onUpdate(values))}
            onCancel={() => setIsOpenSecond(false)}
            cancelText="Болих"
            okText="Хадгалах"
         >
            <Form form={secondForm} layout="vertical">
               <Form.Item label="Хэрэгжүүлэлт:" name="conclusion" rules={[{ required: true, message: 'Заавал' }]}>
                  <TextArea />
               </Form.Item>
               <Form.Item label="Дүгнэлт:" name="implemented" rules={[{ required: true, message: 'Заавал' }]}>
                  <TextArea />
               </Form.Item>
            </Form>
         </Modal>
