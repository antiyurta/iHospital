        ...
        <>
            <page size="A4">
                <div className="flow-root">
                    <p className="float-right" style={{ fontSize: 10 }}>СМ-1-Хавсралт 11</p>
                </div>
                <p className="font-bold text-center" style={{ fontSize: 16 }}>СУВИЛАГЧ ЭМЧЛҮҮЛЭГЧИЙН БИЕИЙН БАЙДЛЫГ ҮНЭЛЭХ ХУУДАС</p>
                <div className="flow-root py-1">
                    ...
                    <div className="float-right inline-flex">
                        ...
                        <p style={{ fontSize: 10 }} className="pl-1">Хүйс:</p>
                        <p style={{ fontSize: 10 }}>{patientData?.genderType === "MAN" ? "Эр" : "Эм"}</p>
                        <p style={{ fontSize: 10 }} className="pl-1">Тасаг:</p>
                        <p style={{ fontSize: 10 }}>{location?.state?.departmentName}</p>
                        <p style={{ fontSize: 10 }} className="pl-1">Өрөө:</p>
                ...
                <Table bordered className="bcp">
                    <thead>
                        <tr>
                            <th rowSpan={2} colSpan={2}>Ангилал</th>
                        ...
                        <tr>
                            <th rowSpan={82} style={{ writingMode: "vertical-rl", textAlign: "center", verticalAlign: 'middle' }}>ӨДӨР ТУТМЫН ҮНЭЛГЭЭ</th>
                            <th rowSpan={21} style={{ writingMode: "vertical-rl", textAlign: "center", verticalAlign: 'middle' }}>
                                <p className="font-semibold" style={{ fontSize: 7 }}>1. Амьсгал/ Зүрх судас</p>
                            </th>
                            <th rowSpan={5} style={{ width: 70 }}>Амьсгалалт</th>
                        ...
                        <tr>
                            <th rowSpan={4} style={{ width: 70 }}>Жигд бус</th>
                        ...
                        <tr>
                            <th colSpan={2} rowSpan={2}>Хялгасан судасны дахин дүүрэлт</th>
                        ...
                        <tr>
                            <th rowSpan={16} style={{ writingMode: "vertical-rl", textAlign: "center", verticalAlign: 'middle' }}>2. Хоол боловсруулалт</th>
                        ...
                        <tr>
                            <th rowSpan={11} style={{ writingMode: "vertical-rl", textAlign: "center", verticalAlign: 'middle' }}>3. Шээс ялгаруулалт</th>
                        ...
                        <tr>
                            <th rowSpan={20} style={{ writingMode: "vertical-rl", textAlign: "center", verticalAlign: 'middle' }}>4. Арьс</th>
                        ...
                        <tr>
                            <th rowSpan={3} colSpan={2}>Уян зүү тавьсан хэсэг</th>
                            <th>Хэвийн</th>
                        </tr>
                        <tr>
                            <th>Улайсан</th>
                        ...
                        <tr>
                            <th rowSpan={21} style={{ writingMode: "vertical-rl", textAlign: "center", verticalAlign: 'middle' }}>5. Мэдрэл, сэтгэхүйн байдал</th>
