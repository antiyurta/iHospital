  ...
  return (
    <div className="flex flex-wrap">
      <div className="w-full pb-1">
        ...
        >
          <Button type="primary" onClick={() => { setPageId(1); }} className={pageId === 1 ? "button-active m-1" : "m-1"}>Cardex</Button>
          <Button type="primary" onClick={() => { setPageId(2); }} className={pageId === 2 ? "button-active m-1" : "m-1"}>Захиалга</Button>
          <Button type="primary" onClick={() => { setPageId(3); }} className={pageId === 3 ? "button-active m-1" : "m-1"}>VS</Button>
          <Button type="primary" onClick={() => { setPageId(4); }} className={pageId === 4 ? "button-active m-1" : "m-1"}>BST</Button>
          <Button type="primary" onClick={() => { setPageId(5); }} className={pageId === 5 ? "button-active m-1" : "m-1"}>Өвдөлтийн үнэлгээ</Button>
          <Button type="primary" onClick={() => { setPageId(6); }} className={pageId === 6 ? "button-active m-1" : "m-1"}>Биеийн байдлыг үнэлэх хуудас</Button>
          <Button type="primary" onClick={() => { setPageId(7); }} className={pageId === 7 ? "button-active m-1" : "m-1"}>Тэмдэглэл</Button>
          <Button type="primary" onClick={() => { setPageId(7); }} className={pageId === 7 ? "button-active m-1" : "m-1"}>Тэмдэглэл</Button>
          <Button type="primary" onClick={() => { setPageId(7); }} className={pageId === 7 ? "button-active m-1" : "m-1"}>Тэмдэглэл</Button>
          <Button type="primary" onClick={() => { setPageId(7); }} className={pageId === 7 ? "button-active m-1" : "m-1"}>Тэмдэглэл</Button>
          <Button type="primary" onClick={() => { setPageId(7); }} className={pageId === 7 ? "button-active m-1" : "m-1"}>Тэмдэглэл</Button>
