...
function PrintIndex({ data }) {
    ...
    return (
        <>
            ...
            <div ref={printRef}>
                <p className="text-center py-10" style={{ fontSize: '20px', fontWeight: 'bold' }}>ӨДРИЙН ОРЛОГО({moment(today).format('YYYY-MM-DD')})</p>
                ...
                <p className="text-center py-1" style={{ fontSize: '15px', fontWeight: 'bold' }}>Хэвлэх огноо: {moment().format('YYYY-MM-DD HH:mm')}</p>
